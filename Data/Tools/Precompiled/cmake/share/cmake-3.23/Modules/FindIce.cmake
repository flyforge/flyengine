...
Components can include any of: ``FrePlasmae``, ``Glacier2``, ``Ice``,
...
Ice slice programs are reported in::
  ...
  Ice_SLICE2FREPLASMAEJ_EXECUTABLE - path to slice2frePlasmaej executable
  Ice_SLICE2FREPLASMAE_EXECUTABLE - path to slice2frePlasmae executable
...
function(_Ice_FIND)
  ...
  if(vcvers)
    foreach(ice_version ${ice_versions})
      foreach(vcver IN LISTS vcvers)
        ...
        list(APPEND frePlasmae_nuget_dirs "zeroc.frePlasmae.v${vcver}.${ice_version}")
      endforeach()
    endforeach()
    ...
    find_path(FrePlasmae_NUGET_DIR
              NAMES "tools/slice2frePlasmae.exe"
              PATH_SUFFIXES ${frePlasmae_nuget_dirs}
              DOC "FrePlasmae NuGet directory")
    if(FrePlasmae_NUGET_DIR)
      list(APPEND ice_roots "${FrePlasmae_NUGET_DIR}")
    endif()
    foreach(ice_version ${ice_versions})
  ...
  find_path(FrePlasmae_INCLUDE_DIR
            NAMES "FrePlasmae/FrePlasmae.h"
            HINTS ${ice_roots}
            PATH_SUFFIXES ${ice_include_suffixes}
            DOC "FrePlasmae include directory")
  set(FrePlasmae_INCLUDE_DIR "${FrePlasmae_INCLUDE_DIR}" PARENT_SCOPE)
...
if(Ice_FOUND)
  ...
  if (FrePlasmae_INCLUDE_DIR)
    list(APPEND Ice_INCLUDE_DIRS "${FrePlasmae_INCLUDE_DIR}")
  endif()
...
if(Ice_DEBUG)
  ...
  message(STATUS "FrePlasmae_INCLUDE_DIR directory: ${FrePlasmae_INCLUDE_DIR}")
