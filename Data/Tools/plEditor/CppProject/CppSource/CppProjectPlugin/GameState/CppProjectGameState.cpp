...
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(CppProjectGameState, 1, plRTTIDefaultAllocator<CppProjectGameState>)
...
{
  PL_LOG_BLOCK("GameState::Deactivate");
...
void CppProjectGameState::AfterWorldUpdate()
{
  ...
  {
    plDebugRenderer::DrawLineSphere(m_pMainWorld, plBoundingSphere::MakeFromCenterAndRadius(plVec3::MakeZero(), 1.0f), plColor::Orange);
  }
