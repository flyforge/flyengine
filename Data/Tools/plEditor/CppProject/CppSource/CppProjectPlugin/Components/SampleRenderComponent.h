...
PL_DECLARE_REFLECTABLE_TYPE(PL_CPPPROJECTPLUGIN_DLL, SampleRenderComponentMask);
...
{
  PL_DECLARE_COMPONENT_TYPE(SampleRenderComponent, plComponent, SampleRenderComponentManager);
