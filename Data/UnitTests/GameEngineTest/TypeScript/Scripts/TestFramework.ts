...
declare function plTestFailure(file: string, line: number, func: string, msg: string): void;
...
function TestFailed(msg: string) {
    ...
    plTestFailure(file, line, func, msg);
}
...
export function FLOAT(f1: number, f2: number, epsilon: number = 0.001) {
    ...
    if (!pl.Utils.IsNumberEqual(f1, f2, epsilon)) {
        TestFailed(f1 + " does not equal " + f2);
    }
}

export function VEC2(v1: pl.Vec2, v2: pl.Vec2, epsilon: number = 0.001) {
...
export function VEC3(v1: pl.Vec3, v2: pl.Vec3, epsilon: number = 0.001) {
...
export function QUAT(q1: pl.Quat, q2: pl.Quat, epsilon: number = 0.001) {
...
export function ARRAY(N: number, v1: number[], v2: number[], epsilon: number = 0.001): void {
    ...
    for (let i = 0; i < N; ++i) {
        ...
        if (!pl.Utils.IsNumberEqual(v1[i], v2[i], epsilon)) {
...
export function COLOR(c1: pl.Color, c2: pl.Color, epsilon: number = 0.001) {
