...
export enum WindStrength {  Calm = 0, LightBreple = 1, GentleBreple = 2, ModerateBreple = 3, StrongBreple = 4, Storm = 5, WeakShockwave = 6, MediumShockwave = 7, StrongShockwave = 8, ExtremeShockwave = 9 }
