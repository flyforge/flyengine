...
{
  // Estevpl and Kulla 2017, "Production Friendly Microfacet Sheen BRDF"
...
float3 BRDF_Specular_Anisotropic(plMaterialData matData, float3 h, float NoV, float NoL, float NoH, float LoH)
{
...
float3 BRDF_Specular_Clearcoat(plMaterialData matData, float NdotH, float VdotH)
{
...
float3 BRDF_Specular_Sheen(plMaterialData matData, float NdotV, float NdotL, float NdotH)
{
...
AccumulatedLight DefaultShadingNew(plMaterialData matData, float3 L, float3 V)
{
