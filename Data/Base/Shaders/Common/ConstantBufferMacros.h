...
#define PACKEDCOLOR4H(Name) uint PLASMA_CONCAT(Name,RG); uint PLASMA_CONCAT(Name,GB)

#define UNPACKHALF2(Name1, Name2, CombinedName) float Name1 = f16tof32(CombinedName); float Name2 = f16tof32(CombinedName >> 16)
#define UNPACKCOLOR4H(Name) RGBA16FToFloat4(PLASMA_CONCAT(Name,RG), PLASMA_CONCAT(Name,GB))
