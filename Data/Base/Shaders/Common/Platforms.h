...
#  define BEGIN_PUSH_CONSTANTS(Name) struct PL_SHADER_STRUCT PL_CONCAT(Name, _PushConstants)
#  define END_PUSH_CONSTANTS(Name) ; [[vk::push_constant]] PL_CONCAT(Name, _PushConstants) Name;
