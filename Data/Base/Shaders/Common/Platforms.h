...
#define PLATFORM_SHADER PLASMA_OFF
#define PLATFORM_DX11 PLASMA_OFF
#define PLATFORM_VULKAN PLASMA_OFF

#if defined(DX11_SM40_93) || defined(DX11_SM40) || defined(DX11_SM41) || defined(DX11_SM50)

  #undef PLATFORM_SHADER
  #define PLATFORM_SHADER PLASMA_ON

  #undef PLATFORM_DX11
  #define PLATFORM_DX11 PLASMA_ON
...
float4 plEvaluateAttributeAtSample(float4 Attribute, uint SampleIndex, uint NumMsaaSamples)
{
  ...
  #define PLATFORM_VULKAN PLASMA_ON
