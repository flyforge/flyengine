...
enum RTCGeometryType
{
  ...
  RTC_GEOMETRY_TYPE_ROUND_BPLASMAIER_CURVE  = 24, // round (tube-like) Bezier curves
  RTC_GEOMETRY_TYPE_FLAT_BPLASMAIER_CURVE   = 25, // flat (ribbon-like) Bezier curves
  RTC_GEOMETRY_TYPE_NORMAL_ORIENTED_BPLASMAIER_CURVE  = 26, // flat normal-oriented Bezier curves
