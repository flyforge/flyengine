if(TARGET glfw)
    pl_set_build_flags(glfw)
    pl_set_default_target_output_dirs(glfw)
    ...
    pl_set_project_ide_folder(glfw "Code/ThirdParty/GLFW")
    pl_set_project_ide_folder(update_mappings "Code/ThirdParty/GLFW")
