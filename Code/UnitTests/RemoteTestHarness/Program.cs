...
namespace plUwpTestHarness
{
  ...
  class Program
  {
    public class Options
    {
      ...
      public string plWorkspace { get; set; }
    ...
    static void Main(string[] args)
    {
      ...
      AppDomain.CurrentDomain.UnhandledException += (object sender, UnhandledExceptionEventArgs eventArgs) =>
      {
        ...
        try
        {
          ...
          var bla = plProcessHelper.RunExternalExe("procdump", args2, absBinDir);
        }
        catch (Exception e)
        {
      ...
      Parser.Default.ParseArguments<Options>(args)
        ...
        {
          plTestUWP test = new plTestUWP(o.plWorkspace, o.testOutputPath, o.configuration, o.platform, o.project);
          test.ExecuteTest();
        });
    }
