...
class PL_TYPESCRIPTPLUGIN_DLL plTypeScriptBinding
{
public:
...
public:
  ...
  PL_ALWAYS_INLINE plDuktapeContext& GetDukTapeContext() { return m_Duk; }
  PL_ALWAYS_INLINE duk_context* GetDukContext() { return m_Duk.GetContext(); }
...
ComponentType* plTypeScriptBinding::ExpectComponent(duk_context* pDuk, plInt32 iObjIdx /*= 0 */)
{
  ...
  PL_VERIFY(pWorld->TryGetComponent(hOwnHandle, pComponent), "Invalid component parameter");
