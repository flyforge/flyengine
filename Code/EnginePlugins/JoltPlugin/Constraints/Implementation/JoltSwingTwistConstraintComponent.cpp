...
PLASMA_BEGIN_COMPONENT_TYPE(plJoltSwingTwistConstraintComponent, 1, plComponentMode::Static)
{
  ...
  {
    PLASMA_ACCESSOR_PROPERTY("SwingLimitY", GetSwingLimitY, SetSwingLimitY)->AddAttributes(new plClampValueAttribute(plAngle(), plAngle::MakeFromDegree(175))),
    PLASMA_ACCESSOR_PROPERTY("SwingLimitZ", GetSwingLimitZ, SetSwingLimitZ)->AddAttributes(new plClampValueAttribute(plAngle(), plAngle::MakeFromDegree(175))),

    PLASMA_ACCESSOR_PROPERTY("Friction", GetFriction, SetFriction)->AddAttributes(new plClampValueAttribute(0.0f, plVariant())),

    PLASMA_ACCESSOR_PROPERTY("LowerTwistLimit", GetLowerTwistLimit, SetLowerTwistLimit)->AddAttributes(new plClampValueAttribute(plAngle::MakeFromDegree(5), plAngle::MakeFromDegree(175)), new plDefaultValueAttribute(plAngle::MakeFromDegree(90))),
    PLASMA_ACCESSOR_PROPERTY("UpperTwistLimit", GetUpperTwistLimit, SetUpperTwistLimit)->AddAttributes(new plClampValueAttribute(plAngle::MakeFromDegree(5), plAngle::MakeFromDegree(175)), new plDefaultValueAttribute(plAngle::MakeFromDegree(90))),
