...
class PL_GAMECOMPONENTS_DLL plHeightfieldComponentManager : public plComponentManager<plHeightfieldComponent, plBlockStorageType::Compact>
{
public:
...
class PL_GAMECOMPONENTS_DLL plHeightfieldComponent : public plRenderComponent
{
  PL_DECLARE_COMPONENT_TYPE(plHeightfieldComponent, plRenderComponent, plHeightfieldComponentManager);
