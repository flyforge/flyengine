...
// clang-format off
PL_BEGIN_COMPONENT_TYPE(plFakeRopeComponent, 3, plComponentMode::Static)
  {
    PL_BEGIN_PROPERTIES
    {
      ...
      PL_ACCESSOR_PROPERTY("AttachToAnchor1", GetAttachToAnchor1, SetAttachToAnchor1)->AddAttributes(new plDefaultValueAttribute(true)),
      PL_ACCESSOR_PROPERTY("AttachToAnchor2", GetAttachToAnchor2, SetAttachToAnchor2)->AddAttributes(new plDefaultValueAttribute(true)),
      PL_MEMBER_PROPERTY("Pieces", m_uiPieces)->AddAttributes(new plDefaultValueAttribute(32), new plClampValueAttribute(2, 200)),
      PL_ACCESSOR_PROPERTY("Slack", GetSlack, SetSlack)->AddAttributes(new plDefaultValueAttribute(0.2f)),
      PL_MEMBER_PROPERTY("Damping", m_fDamping)->AddAttributes(new plDefaultValueAttribute(0.5f), new plClampValueAttribute(0.0f, 1.0f)),
      PL_MEMBER_PROPERTY("WindInfluence", m_fWindInfluence)->AddAttributes(new plDefaultValueAttribute(0.2f), new plClampValueAttribute(0.0f, 10.0f)),
    }
    PL_END_PROPERTIES;
    PL_BEGIN_ATTRIBUTES
    {
...
void plFakeRopeComponentManager::Initialize()
{
  ...
  {
    auto desc = PL_CREATE_MODULE_UPDATE_FUNCTION_DESC(plFakeRopeComponentManager::Update, this);
