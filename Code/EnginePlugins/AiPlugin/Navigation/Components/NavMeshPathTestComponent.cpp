...
void plAiNavMeshPathTestComponent::Update()
{
  ...
  {
    m_Navigation.DebugDraw(GetWorld(), m_bVisualizePathCorridor ? plColor::Aquamarine.WithAlpha(0.2f) : plColor::ZeroColor(), m_bVisualizePathLine ? plColor::Lime : plColor::ZeroColor());
  }
