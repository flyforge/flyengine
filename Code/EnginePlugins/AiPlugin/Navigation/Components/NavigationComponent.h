...
class PLASMA_AIPLUGIN_DLL plAiNavigationComponent : public plComponent
{
  PLASMA_DECLARE_COMPONENT_TYPE(plAiNavigationComponent, plComponent, plAiNavigationComponentManager);
