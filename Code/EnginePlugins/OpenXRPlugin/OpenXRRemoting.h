...
{
  PL_DECLARE_SINGLETON_OF_INTERFACE(plOpenXRRemoting, plXRRemotingInterface);
...
public:
  ...
  virtual plResult Connect(const char* szRemoteHostName, uint16_t remotePort, bool bEnableAudio, int iMaxBitrateKbps) override;
