...
struct PLASMA_RECASTPLUGIN_DLL plRecastNavMeshResourceDescriptor
{
...
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plRecastNavMeshResource, plResource);
  PLASMA_RESOURCE_DECLARE_COMMON_CODE(plRecastNavMeshResource);
  PLASMA_RESOURCE_DECLARE_CREATEABLE(plRecastNavMeshResource, plRecastNavMeshResourceDescriptor);
