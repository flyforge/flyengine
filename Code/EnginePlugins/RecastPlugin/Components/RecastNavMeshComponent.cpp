...
// clang-format off
PL_BEGIN_ABSTRACT_COMPONENT_TYPE(plRcComponent, 1)
{
  PL_BEGIN_ATTRIBUTES
  {
...
// clang-format off
PL_BEGIN_COMPONENT_TYPE(plRcNavMeshComponent, 2, plComponentMode::Static)
{
  PL_BEGIN_ATTRIBUTES
  {
  ...
  PL_BEGIN_PROPERTIES
  {
    PL_MEMBER_PROPERTY("ShowNavMesh", m_bShowNavMesh),
    PL_MEMBER_PROPERTY("NavMeshConfig", m_NavMeshConfig),
  }
  PL_END_PROPERTIES;
  PL_BEGIN_FUNCTIONS
  {
...
void plRcNavMeshComponent::OnObjectCreated(const plAbstractObjectNode& node)
{
  ...
  sNavMeshFile.SetFormat(":project/AssetCache/Generated/{0}.plRecastNavMesh", sComponentGuid);
...
void plRcNavMeshComponentManager::Initialize()
{
  ...
  auto desc = PL_CREATE_MODULE_UPDATE_FUNCTION_DESC(plRcNavMeshComponentManager::Update, this);
