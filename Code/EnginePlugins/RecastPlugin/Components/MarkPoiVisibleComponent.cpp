...
// clang-format off
PLASMA_BEGIN_COMPONENT_TYPE(plRcMarkPoiVisibleComponent, 1, plComponentMode::Static)
{
  PLASMA_BEGIN_PROPERTIES
  {
    PLASMA_MEMBER_PROPERTY("Radius", m_fRadius)->AddAttributes(new plDefaultValueAttribute(20.0f)),
