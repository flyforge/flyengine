...
class PL_RECASTPLUGIN_DLL plRcAgentComponentManager : public plComponentManager<class plRcAgentComponent, plBlockStorageType::FreeList>
{
...
class PL_RECASTPLUGIN_DLL plRcAgentComponent : public plAgentSteeringComponent
{
  PL_DECLARE_COMPONENT_TYPE(plRcAgentComponent, plAgentSteeringComponent, plRcAgentComponentManager);
