...
struct PL_RECASTPLUGIN_DLL plRecastConfig
{
...
PL_DECLARE_REFLECTABLE_TYPE(PL_RECASTPLUGIN_DLL, plRecastConfig);



class PL_RECASTPLUGIN_DLL plRecastNavMeshBuilder
{
public:
