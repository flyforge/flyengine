...
// clang-format off
PLASMA_BEGIN_STATIC_REFLECTED_TYPE(plRecastConfig, plNoBase, 1, plRTTIDefaultAllocator<plRecastConfig>)
{
  PLASMA_BEGIN_PROPERTIES
  {
    ...
    PLASMA_MEMBER_PROPERTY("RegionMergeSize", m_fRegionMergeSize)->AddAttributes(new plDefaultValueAttribute(20.0f)),
    PLASMA_MEMBER_PROPERTY("SampleDistanceFactor", m_fDetailMeshSampleDistanceFactor)->AddAttributes(new plDefaultValueAttribute(1.0f)),
    PLASMA_MEMBER_PROPERTY("SampleErrorFactor", m_fDetailMeshSampleErrorFactor)->AddAttributes(new plDefaultValueAttribute(1.0f)),
    PLASMA_MEMBER_PROPERTY("MaxSimplification", m_fMaxSimplificationError)->AddAttributes(new plDefaultValueAttribute(1.3f)),
    PLASMA_MEMBER_PROPERTY("MaxEdgeLength", m_fMaxEdgeLength)->AddAttributes(new plDefaultValueAttribute(4.0f)),
  }
...
{
  PLASMA_LOG_BLOCK("plRecastNavMeshBuilder::GenerateTriangleMesh");
