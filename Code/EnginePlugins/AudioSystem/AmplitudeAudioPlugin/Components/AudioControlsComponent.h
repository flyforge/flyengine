...
class PL_AMPLITUDEAUDIOPLUGIN_DLL plAudioControlsComponent : public plAmplitudeComponent
{
  PL_DECLARE_COMPONENT_TYPE(plAudioControlsComponent, plAmplitudeComponent, plAudioControlsComponentManager);
