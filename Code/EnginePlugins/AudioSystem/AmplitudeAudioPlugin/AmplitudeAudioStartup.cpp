...
PLASMA_BEGIN_SUBSYSTEM_DECLARATION(SparkyStudios, AmplitudeAudioPlugin)
  ...
  {
    s_pAmplitudeSingleton = PLASMA_AUDIOSYSTEM_NEW(plAmplitude);
  ...
  ON_HIGHLEVELSYSTEMS_SHUTDOWN
  {
    ...
    PLASMA_AUDIOSYSTEM_DELETE(s_pAmplitudeSingleton);
  }
...
PLASMA_STATICLINK_FILE(AmplitudeAudioPlugin, AmplitudeAudioPlugin_AmplitudeAudioPluginStartup);
