...
struct PLASMA_AMPLITUDEAUDIOPLUGIN_DLL plAmplitudeAudioControlCollectionEntry
{
...
struct PLASMA_AMPLITUDEAUDIOPLUGIN_DLL plAmplitudeAudioControlCollectionResourceDescriptor
{
...
class PLASMA_AMPLITUDEAUDIOPLUGIN_DLL plAmplitudeAudioControlCollectionResource : public plResource
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAmplitudeAudioControlCollectionResource, plResource);
  PLASMA_RESOURCE_DECLARE_COMMON_CODE(plAmplitudeAudioControlCollectionResource);
  PLASMA_RESOURCE_DECLARE_CREATEABLE(plAudioControlCollectionResource, plAmplitudeAudioControlCollectionResourceDescriptor);
...
public:
  ...
  PLASMA_NODISCARD const plAmplitudeAudioControlCollectionResourceDescriptor& GetDescriptor() const;
