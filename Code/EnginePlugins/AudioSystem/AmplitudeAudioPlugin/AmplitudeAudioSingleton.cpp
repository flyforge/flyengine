...
namespace Memory
{
  ...
  {
    return plAudioMiddlewareAllocatorWrapper::GetAllocator()->Allocate(size, PLASMA_AUDIOSYSTEM_MEMORY_ALIGNMENT);
  }
  ...
  static Amplitude::AmVoidPtr Realloc(Amplitude::MemoryPoolKind pool, Amplitude::AmVoidPtr address, Amplitude::AmSize size)
  {
    ...
    return plAudioMiddlewareAllocatorWrapper::GetAllocator()->Reallocate(address, plAudioMiddlewareAllocatorWrapper::GetAllocator()->AllocatedSize(address), size, PLASMA_AUDIOSYSTEM_MEMORY_ALIGNMENT);
  }
...
PLASMA_IMPLEMENT_SINGLETON(plAmplitude);
...
{
  m_pData = PLASMA_NEW(plAudioMiddlewareAllocatorWrapper::GetAllocator(), Data);
}
...
plResult plAmplitude::Startup()
{
  ...
  PLASMA_ASSERT_DEBUG(m_pEngine != nullptr, "Amplitude engine not available.");
  ...
  PLASMA_ASSERT_DEBUG(Amplitude::MemoryManager::IsInitialized(), "Amplitude memory manager not initialized.");
...
plResult plAmplitude::AddEntity(plAudioSystemEntityData* pEntityData, const char* szEntityName)
{
  ...
  return entity.Valid() ? PLASMA_SUCCESS : PLASMA_FAILURE;
}
...
plResult plAmplitude::RemoveEntity(plAudioSystemEntityData* pEntityData)
{
  ...
  return entity.Valid() ? PLASMA_FAILURE : PLASMA_SUCCESS;
}
...
plResult plAmplitude::AddListener(plAudioSystemListenerData* pListenerData, const char* szListenerName)
{
  ...
  return listener.Valid() ? PLASMA_SUCCESS : PLASMA_FAILURE;
}
...
plResult plAmplitude::RemoveListener(plAudioSystemListenerData* pListenerData)
{
  ...
  return listener.Valid() ? PLASMA_FAILURE : PLASMA_SUCCESS;
}
...
{
  return PLASMA_NEW(plAudioMiddlewareAllocatorWrapper::GetAllocator(), plAmplitudeAudioEntityData, uiEntityId, false);
}

plAudioSystemEntityData* plAmplitude::CreateEntityData(plAudioSystemDataID uiEntityId)
{
  return PLASMA_NEW(plAudioMiddlewareAllocatorWrapper::GetAllocator(), plAmplitudeAudioEntityData, uiEntityId);
}
...
plResult plAmplitude::DestroyEntityData(plAudioSystemEntityData* pEntityData)
{
  ...
  PLASMA_DELETE(plAudioMiddlewareAllocatorWrapper::GetAllocator(), pEntityData);
  return PLASMA_SUCCESS;
}

plAudioSystemListenerData* plAmplitude::CreateListenerData(plAudioSystemDataID uiListenerId)
{
  return PLASMA_NEW(plAudioMiddlewareAllocatorWrapper::GetAllocator(), plAmplitudeAudioListenerData, uiListenerId);
}
...
plResult plAmplitude::DestroyListenerData(plAudioSystemListenerData* pListenerData)
{
  ...
  PLASMA_DELETE(plAudioMiddlewareAllocatorWrapper::GetAllocator(), pListenerData);
  return PLASMA_SUCCESS;
}

plAudioSystemEventData* plAmplitude::CreateEventData(plAudioSystemDataID uiEventId)
{
  return PLASMA_NEW(plAudioMiddlewareAllocatorWrapper::GetAllocator(), plAmplitudeAudioEventData, uiEventId);
}
...
plResult plAmplitude::ResetEventData(plAudioSystemEventData* pEventData)
{
  ...
  PLASMA_DELETE(plAudioMiddlewareAllocatorWrapper::GetAllocator(), pEventData);
  return PLASMA_SUCCESS;
}
...
plAudioSystemBankData* plAmplitude::DeserializeBankEntry(plStreamReader* pBankEntry)
{
  ...
  *pBankEntry >> sFileName;
  ...
  return PLASMA_NEW(plAudioMiddlewareAllocatorWrapper::GetAllocator(), plAmplitudeAudioSoundBankData, uiAmId, sFileName);
}
...
plResult plAmplitude::DestroyBank(plAudioSystemBankData* pBankData)
{
  ...
  PLASMA_DELETE(plAudioMiddlewareAllocatorWrapper::GetAllocator(), pBankData);
  return PLASMA_SUCCESS;
}
...
plAudioSystemTriggerData* plAmplitude::DeserializeTriggerEntry(plStreamReader* pTriggerEntry) const
{
  ...
  *pTriggerEntry >> uiAmId;
  ...
  return PLASMA_NEW(plAudioMiddlewareAllocatorWrapper::GetAllocator(), plAmplitudeAudioTriggerData, uiAmId);
}
...
plResult plAmplitude::DestroyTriggerData(plAudioSystemTriggerData* pTriggerData)
{
  ...
  PLASMA_DELETE(plAudioMiddlewareAllocatorWrapper::GetAllocator(), pTriggerData);
  return PLASMA_SUCCESS;
}
...
plAudioSystemRtpcData* plAmplitude::DeserializeRtpcEntry(plStreamReader* pRtpcEntry) const
{
  ...
  *pRtpcEntry >> uiAmId;
  ...
  return PLASMA_NEW(plAudioMiddlewareAllocatorWrapper::GetAllocator(), plAmplitudeAudioRtpcData, uiAmId);
}
...
plResult plAmplitude::DestroyRtpcData(plAudioSystemRtpcData* pRtpcData)
{
  ...
  PLASMA_DELETE(plAudioMiddlewareAllocatorWrapper::GetAllocator(), pRtpcData);
  return PLASMA_SUCCESS;
}
...
plAudioSystemSwitchStateData* plAmplitude::DeserializeSwitchStateEntry(plStreamReader* pSwitchStateEntry) const
{
  ...
  *pSwitchStateEntry >> uiSwitchStateId;
  ...
  return PLASMA_NEW(plAudioMiddlewareAllocatorWrapper::GetAllocator(), plAmplitudeAudioSwitchStateData, uiSwitchId, uiSwitchStateId);
}
...
plResult plAmplitude::DestroySwitchStateData(plAudioSystemSwitchStateData* pSwitchStateData)
{
  ...
  PLASMA_DELETE(plAudioMiddlewareAllocatorWrapper::GetAllocator(), pSwitchStateData);
  return PLASMA_SUCCESS;
}
...
plAudioSystemEnvironmentData* plAmplitude::DeserializeEnvironmentEntry(plStreamReader* pEnvironmentEntry) const
{
  ...
  *pEnvironmentEntry >> uiEffectId;
  ...
  return PLASMA_NEW(plAudioMiddlewareAllocatorWrapper::GetAllocator(), plAmplitudeAudioEnvironmentData, uiEnvironmentId, uiEffectId);
}
...
plResult plAmplitude::DestroyEnvironmentData(plAudioSystemEnvironmentData* pEnvironmentData)
{
  ...
  PLASMA_DELETE(plAudioMiddlewareAllocatorWrapper::GetAllocator(), pEnvironmentData);
  return PLASMA_SUCCESS;
}
...
void plAmplitude::Update(plTime delta)
{
  ...
  PLASMA_ASSERT_DEV(m_pData != nullptr, "UpdateSound() should not be called at this time.");
...
PLASMA_STATICLINK_FILE(AmplitudeAudioPlugin, AmplitudeAudioPlugin_AmplitudeAudioSingleton);
