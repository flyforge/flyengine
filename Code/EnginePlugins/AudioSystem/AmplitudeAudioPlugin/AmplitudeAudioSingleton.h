...
struct PLASMA_AMPLITUDEAUDIOPLUGIN_DLL plAmplitudeConfiguration
{
...
struct PLASMA_AMPLITUDEAUDIOPLUGIN_DLL plAmplitudeAssetProfiles
{
...
class PLASMA_AMPLITUDEAUDIOPLUGIN_DLL plAmplitude final : public plAudioMiddleware
{
private:
  PLASMA_DECLARE_SINGLETON_OF_INTERFACE(plAmplitude, plAudioMiddleware);
...
public:
  ...
  PLASMA_NODISCARD SparkyStudios::Audio::Amplitude::Engine* GetEngine() const { return m_pEngine; }
