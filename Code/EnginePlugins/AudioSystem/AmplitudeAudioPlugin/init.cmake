# set (PLASMA_3RDPARTY_AMPLITUDE_SUPPORT ON CACHE BOOL "Whether to add support for the Amplitude Audio Engine.")
# mark_as_advanced(FORCE PLASMA_3RDPARTY_AMPLITUDE_SUPPORT)

# # Amplitude installation path
# set(PLASMA_AMPLITUDE_SDK_PATH "" CACHE PATH "The path to Amplitude Audio SDK libraries.")
...
#     "${PLASMA_AMPLITUDE_SDK_PATH}"
#     "$ENV{PLASMA_AMPLITUDE_ROOT_PATH}"
# )
...
#         set(PLASMA_AMPLITUDE_SDK_PATH "${candidate_path}")
#         break()
#     endif()
# endforeach()
...
# message(STATUS "Using Amplitude Audio SDK at ${PLASMA_AMPLITUDE_SDK_PATH}")
...
# get_filename_component(AMPLITUDE_INSTALL_ROOT ${PLASMA_AMPLITUDE_SDK_PATH} DIRECTORY)
# get_filename_component(AMPLITUDE_FOLDER ${PLASMA_AMPLITUDE_SDK_PATH} NAME)
...
#     pl_requires(PLASMA_3RDPARTY_AMPLITUDE_SUPPORT)
# endmacro()
