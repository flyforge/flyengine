...
class PL_AUDIOSYSTEMPLUGIN_DLL plAudioTriggerComponentManager : public plComponentManager<class plAudioTriggerComponent, plBlockStorageType::FreeList>
{
public:
...
private:
  ...
  PL_NODISCARD const ObstructionOcclusionState& GetObstructionOcclusionState(plUInt32 uiIndex) const { return m_ObstructionOcclusionStates[uiIndex]; }
...
class PL_AUDIOSYSTEMPLUGIN_DLL plAudioTriggerComponent : public plAudioSystemProxyDependentComponent
{
  PL_DECLARE_COMPONENT_TYPE(plAudioTriggerComponent, plAudioSystemProxyDependentComponent, plAudioTriggerComponentManager);
...
public:
  ...
  PL_NODISCARD plUInt8 GetOcclusionCollisionLayer() const { return m_uiOcclusionCollisionLayer; }
  ...
  PL_NODISCARD const plString& GetPlayTrigger() const;
  ...
  PL_NODISCARD const plString& GetStopTrigger() const;

  /// \brief Gets the internal state of the play trigger.
  /// \returns An plEnum with the value of the play trigger state.
  PL_NODISCARD const plEnum<plAudioSystemTriggerState>& GetState() const;
  ...
  PL_NODISCARD bool IsLoading() const;
  ...
  PL_NODISCARD bool IsReady() const;
  ...
  PL_NODISCARD bool IsStarting() const;
  ...
  PL_NODISCARD bool IsPlaying() const;
  ...
  PL_NODISCARD bool IsStopping() const;
  ...
  PL_NODISCARD bool IsStopped() const;
  ...
  PL_NODISCARD bool IsUnloading() const;
