...
class PL_AUDIOSYSTEMPLUGIN_DLL plAudioBoxEnvironmentComponent : public plAudioSystemEnvironmentComponent
{
  PL_DECLARE_COMPONENT_TYPE(plAudioBoxEnvironmentComponent, plAudioSystemEnvironmentComponent, plAudioBoxEnvironmentComponentManager);
...
public:
  ...
  PL_NODISCARD const plVec3& GetHalfExtends() const;
