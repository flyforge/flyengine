...
class PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioRtpcComponent : public plAudioSystemProxyDependentComponent
{
  PLASMA_DECLARE_COMPONENT_TYPE(plAudioRtpcComponent, plAudioSystemProxyDependentComponent, plAudioRtpcComponentManager);
