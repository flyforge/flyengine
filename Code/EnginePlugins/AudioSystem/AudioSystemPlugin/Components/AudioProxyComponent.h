...
class PL_AUDIOSYSTEMPLUGIN_DLL plAudioProxyComponent : public plAudioSystemComponent, public plRefCounted
{
  PL_DECLARE_COMPONENT_TYPE(plAudioProxyComponent, plAudioSystemComponent, plAudioProxyComponentManager);
