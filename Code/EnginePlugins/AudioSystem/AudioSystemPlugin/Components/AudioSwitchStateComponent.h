...
class PL_AUDIOSYSTEMPLUGIN_DLL plAudioSwitchStateComponent : public plAudioSystemProxyDependentComponent
{
  PL_DECLARE_COMPONENT_TYPE(plAudioSwitchStateComponent, plAudioSystemProxyDependentComponent, plAudioSwitchStateComponentManager);
...
public:
  ...
  PL_NODISCARD const plString& GetState() const;
