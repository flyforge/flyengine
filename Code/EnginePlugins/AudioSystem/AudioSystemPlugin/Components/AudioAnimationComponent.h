...
class PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioAnimationEntry : public plReflectedClass
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioAnimationEntry, plReflectedClass);
...
class PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioAnimationComponent : public plEventMessageHandlerComponent
{
  PLASMA_DECLARE_COMPONENT_TYPE(plAudioAnimationComponent, plEventMessageHandlerComponent, plAudioAnimationComponentManager);
