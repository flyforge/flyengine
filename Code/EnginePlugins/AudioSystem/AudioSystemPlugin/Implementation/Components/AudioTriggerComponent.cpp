...
// clang-format off
PL_BEGIN_COMPONENT_TYPE(plAudioTriggerComponent, kVersion_AudioTriggerComponent, plComponentMode::Static)
{
  PL_BEGIN_PROPERTIES
  {
    PL_MEMBER_PROPERTY("PlayTrigger", m_sPlayTrigger),
    PL_MEMBER_PROPERTY("StopTrigger", m_sStopTrigger),
    PL_ENUM_MEMBER_PROPERTY("SoundObstructionType", plAudioSystemSoundObstructionType, m_eObstructionType),
    PL_ACCESSOR_PROPERTY("OcclusionCollisionLayer", GetOcclusionCollisionLayer, SetOcclusionCollisionLayer)->AddAttributes(new plDynamicEnumAttribute("PhysicsCollisionLayer")),
    PL_MEMBER_PROPERTY("LoadOnInit", m_bLoadOnInit),
    PL_MEMBER_PROPERTY("PlayOnActivate", m_bPlayOnActivate),

    PL_ACCESSOR_PROPERTY_READ_ONLY("IsLoading", IsLoading)->AddAttributes(new plHiddenAttribute()),
    PL_ACCESSOR_PROPERTY_READ_ONLY("IsReady", IsReady)->AddAttributes(new plHiddenAttribute()),
    PL_ACCESSOR_PROPERTY_READ_ONLY("IsStarting", IsStarting)->AddAttributes(new plHiddenAttribute()),
    PL_ACCESSOR_PROPERTY_READ_ONLY("IsPlaying", IsPlaying)->AddAttributes(new plHiddenAttribute()),
    PL_ACCESSOR_PROPERTY_READ_ONLY("IsStopping", IsStopping)->AddAttributes(new plHiddenAttribute()),
    PL_ACCESSOR_PROPERTY_READ_ONLY("IsStopped", IsStopped)->AddAttributes(new plHiddenAttribute()),
    PL_ACCESSOR_PROPERTY_READ_ONLY("IsUnloading", IsUnloading)->AddAttributes(new plHiddenAttribute()),
  }
  PL_END_PROPERTIES;

  PL_BEGIN_FUNCTIONS
  {
    PL_SCRIPT_FUNCTION_PROPERTY(Play, In, "Sync"),
    PL_SCRIPT_FUNCTION_PROPERTY(Stop, In, "Sync"),
    PL_SCRIPT_FUNCTION_PROPERTY(SetPlayTrigger, In, "PlayTrigger"),
    PL_SCRIPT_FUNCTION_PROPERTY(SetStopTrigger, In, "StopTrigger"),
    PL_SCRIPT_FUNCTION_PROPERTY(GetPlayTrigger),
    PL_SCRIPT_FUNCTION_PROPERTY(GetStopTrigger),
  }
  PL_END_FUNCTIONS;
}
...
void plAudioTriggerComponentManager::Initialize()
{
  ...
  {
    auto desc = PL_CREATE_MODULE_UPDATE_FUNCTION_DESC(plAudioTriggerComponentManager::ProcessOcclusion, this);
  ...
  {
    auto desc = PL_CREATE_MODULE_UPDATE_FUNCTION_DESC(plAudioTriggerComponentManager::Update, this);
...
PL_STATICLINK_FILE(AudioSystemPlugin, AudioSystemPlugin_Implementation_Components_AudioTriggerComponent);
