...
// clang-format off
PL_BEGIN_COMPONENT_TYPE(plAudioListenerComponent, kVersion_AudioListenerComponent, plComponentMode::Static)
{
  PL_BEGIN_PROPERTIES
  {
    PL_ACCESSOR_PROPERTY("PositionGameObject", _DoNotCall, SetListenerPositionObject)->AddAttributes(new plGameObjectReferenceAttribute()),
    PL_ACCESSOR_PROPERTY("RotationGameObject", _DoNotCall, SetListenerOrientationObject)->AddAttributes(new plGameObjectReferenceAttribute()),
    PL_ACCESSOR_PROPERTY("IsDefault", IsDefault, SetDefault)->AddAttributes(new plDefaultValueAttribute(false)),
    PL_MEMBER_PROPERTY("PositionOffset", m_vListenerPositionOffset),
  }
  PL_END_PROPERTIES;
}
...
PL_STATICLINK_FILE(AudioSystem, AudioSystemPlugin_Implementation_Components_AudioListenerComponent);
