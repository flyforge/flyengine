...
// clang-format off
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plAudioAnimationEntry, kVersion_AudioAnimationEntry, plRTTIDefaultAllocator<plAudioAnimationEntry>)
{
  PL_BEGIN_PROPERTIES
  {
    PL_MEMBER_PROPERTY("Event", m_sEventName),
    PL_MEMBER_PROPERTY("Trigger", m_sTriggerName),
    PL_ACCESSOR_PROPERTY("Joint", GetJointName, SetJointName),
  }
  PL_END_PROPERTIES;
}
PL_END_DYNAMIC_REFLECTED_TYPE;

PL_BEGIN_COMPONENT_TYPE(plAudioAnimationComponent, kVersion_AudioAnimationComponent, plComponentMode::Static)
{
  PL_BEGIN_ATTRIBUTES
  {
  ...
  PL_BEGIN_PROPERTIES
  {
    PL_ARRAY_MEMBER_PROPERTY("Events", m_EventEntries),
  }
  PL_END_PROPERTIES;
  ...
  PL_BEGIN_MESSAGEHANDLERS
  {
    ...
    PL_MESSAGE_HANDLER(plMsgGenericEvent, OnAnimationEvent),
  }
...
PL_STATICLINK_FILE(AudioSystemPlugin, AudioSystemPlugin_Implementation_Components_AudioAnimationComponent);
