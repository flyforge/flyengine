...
// clang-format off
PL_BEGIN_COMPONENT_TYPE(plAudioSphereEnvironmentComponent, kVersion_AudioSphereEnvironmentComponent, plComponentMode::Static)
{
  PL_BEGIN_ATTRIBUTES
  {
  ...
  PL_BEGIN_PROPERTIES
  {
    PL_ACCESSOR_PROPERTY("Radius", GetRadius, SetRadius)->AddAttributes(new plDefaultValueAttribute(1.0f), new plClampValueAttribute(0.1f, plVariant()), new plSuffixAttribute(" m")),
  }
  PL_END_PROPERTIES;
}
...
PL_STATICLINK_FILE(AudioSystemPlugin, AudioSystemPlugin_Implementation_Components_AudioSphereEnvironmentComponent);
