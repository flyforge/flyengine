...
// clang-format off
PLASMA_BEGIN_COMPONENT_TYPE(plAudioBoxEnvironmentComponent, kVersion_AudioBoxEnvironmentComponent, plComponentMode::Static)
{
  ...
  {
    PLASMA_ACCESSOR_PROPERTY("HalfExtends", GetHalfExtends, SetHalfExtends)->AddAttributes(new plDefaultValueAttribute(plVec3(0.5f)), new plClampValueAttribute(0.1f, plVariant()), new plSuffixAttribute(" m")),
  }
