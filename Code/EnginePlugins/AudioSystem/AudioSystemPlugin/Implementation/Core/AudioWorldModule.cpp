...
// clang-format off
PL_IMPLEMENT_WORLD_MODULE(plAudioWorldModule);

PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plAudioWorldModule, 1, plRTTINoAllocator)
...
PL_STATICLINK_FILE(AudioSystemPlugin, AudioSystemPlugin_Implementation_Core_AudioWorldModule);
