...
#define PL_DECLARE_AUDIOSYSTEM_REQUEST_CALLBACK(name) \
  using CallbackType = plDelegate<void(const name&)>; \
  CallbackType m_Callback


/// \brief Helper macro to declare a new audio system request.
#define PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE_SIMPLE(name)                                          \
  ...
  PL_DECLARE_AUDIOSYSTEM_REQUEST_CALLBACK(name)


/// \brief Helper macro to declare a new audio system request.
#define PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE(name, eq_ex)                                                  \
  bool operator==(const name& rhs) const                                                                      \
  {                                                                                                           \
...
#define PL_DECLARE_AUDIOSYSTEM_REQUEST_HASH_SIMPLE(name)      \
  template <>                                                     \
  struct plHashHelper<name>                                       \
  {                                                               \
    PL_ALWAYS_INLINE static plUInt32 Hash(const name& value)  \
    {                                                             \
      return plHashHelper<plAudioSystemRequest>::Hash(value);     \
    }                                                             \
    PL_ALWAYS_INLINE static bool                              \
...
/// \brief Helper macro to declare an plHashHelper implementation of an audio system request.
#define PL_DECLARE_AUDIOSYSTEM_REQUEST_HASH(name, hash_ex)                                                    \
  template <>                                                                                                     \
  struct plHashHelper<name>                                                                                       \
  {                                                                                                               \
    PL_ALWAYS_INLINE static plUInt32 Hash(const name& value)                                                  \
...
#define PL_DECLARE_AUDIOSYSTEM_REQUEST_STREAM_OPERATORS(name)                          \
  PL_AUDIOSYSTEMPLUGIN_DLL void operator<<(plStreamWriter& Stream, const name& Value); \
  PL_AUDIOSYSTEMPLUGIN_DLL void operator>>(plStreamReader& Stream, name& Value)


/// \brief Helper macro to declare a new audio system request.
#define PL_DECLARE_AUDIOSYSTEM_REQUEST_SIMPLE(name)            \
  PL_DECLARE_AUDIOSYSTEM_REQUEST_HASH_SIMPLE(name);            \
  PL_DECLARE_AUDIOSYSTEM_REQUEST_STREAM_OPERATORS(name);       \
  PL_DECLARE_REFLECTABLE_TYPE(PL_AUDIOSYSTEMPLUGIN_DLL, name); \
  PL_DECLARE_CUSTOM_VARIANT_TYPE(name)


/// \brief Helper macro to declare a new audio system request.
#define PL_DECLARE_AUDIOSYSTEM_REQUEST(name, hash_ex)          \
  PL_DECLARE_AUDIOSYSTEM_REQUEST_HASH(name, hash_ex);          \
  PL_DECLARE_AUDIOSYSTEM_REQUEST_STREAM_OPERATORS(name);       \
  PL_DECLARE_REFLECTABLE_TYPE(PL_AUDIOSYSTEMPLUGIN_DLL, name); \
  PL_DECLARE_CUSTOM_VARIANT_TYPE(name)
...
#define PL_DEFINE_AUDIOSYSTEM_STREAM_OPERATORS_SIMPLE(name)   \
...
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequest
{
...
{
  PL_ALWAYS_INLINE static plUInt32 Hash(const plAudioSystemRequest& value)
  {
  ...
  PL_ALWAYS_INLINE static bool Equal(const plAudioSystemRequest& a, const plAudioSystemRequest& b)
  {
    return a == b;
  }
};
...
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestRegisterEntity : public plAudioSystemRequest
{
...
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestSetEntityTransform : public plAudioSystemRequest
{
...
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestUnregisterEntity : public plAudioSystemRequest
{
  PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE_SIMPLE(plAudioSystemRequestUnregisterEntity);
};

/// \brief Audio request to register a new listener in the audio system.
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestRegisterListener : public plAudioSystemRequest
{
  PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE(plAudioSystemRequestRegisterListener, m_sName == rhs.m_sName);
...
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestSetListenerTransform : public plAudioSystemRequest
{
  PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE(plAudioSystemRequestSetListenerTransform, m_Transform == rhs.m_Transform);

  plAudioSystemTransform m_Transform;
};

/// \brief Audio request to unregister a listener from the audio system.
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestUnregisterListener : public plAudioSystemRequest
{
  PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE_SIMPLE(plAudioSystemRequestUnregisterListener);
};

/// \brief Audio request to load data needed to activate a trigger.
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestLoadTrigger : public plAudioSystemRequest
{
  PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE(plAudioSystemRequestLoadTrigger, m_uiEventId == rhs.m_uiEventId);
...
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestActivateTrigger : public plAudioSystemRequest
{
  PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE(plAudioSystemRequestActivateTrigger, m_uiEventId == rhs.m_uiEventId);
...
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestStopEvent : public plAudioSystemRequest
{
...
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestUnloadTrigger : public plAudioSystemRequest
{
  PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE_SIMPLE(plAudioSystemRequestUnloadTrigger);
};

/// \brief Audio request to set the value of a real-time parameter.
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestSetRtpcValue : public plAudioSystemRequest
{
...
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestSetSwitchState : public plAudioSystemRequest
{
...
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestSetEnvironmentAmount : public plAudioSystemRequest
{
  PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE(plAudioSystemRequestSetEnvironmentAmount, m_fAmount == rhs.m_fAmount);
...
/// \brief Audio request to set the current amount of an environment on the specified entity.
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestSetObstructionOcclusion : public plAudioSystemRequest
{
  PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE(plAudioSystemRequestSetObstructionOcclusion, m_fObstruction == rhs.m_fObstruction && m_fOcclusion == rhs.m_fOcclusion);
...
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestLoadBank : public plAudioSystemRequest
{
  PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE_SIMPLE(plAudioSystemRequestLoadBank);
};

/// \brief Audio request to unload a sound bank.
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestUnloadBank : public plAudioSystemRequest
{
  PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE_SIMPLE(plAudioSystemRequestUnloadBank);
};
...
struct PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRequestShutdown : public plAudioSystemRequest
{  
  PL_DECLARE_AUDIOSYSTEM_REQUEST_TYPE_SIMPLE(plAudioSystemRequestShutdown);
};

PL_DECLARE_AUDIOSYSTEM_REQUEST_STREAM_OPERATORS(plAudioSystemRequest);
PL_DECLARE_REFLECTABLE_TYPE(PL_AUDIOSYSTEMPLUGIN_DLL, plAudioSystemRequest);

PL_DECLARE_AUDIOSYSTEM_REQUEST(plAudioSystemRequestRegisterEntity, plHashHelper<plString>::Hash(value.m_sName));
PL_DECLARE_AUDIOSYSTEM_REQUEST(plAudioSystemRequestSetEntityTransform, plHashHelper<plAudioSystemTransform>::Hash(value.m_Transform));
PL_DECLARE_AUDIOSYSTEM_REQUEST_SIMPLE(plAudioSystemRequestUnregisterEntity);
PL_DECLARE_AUDIOSYSTEM_REQUEST(plAudioSystemRequestRegisterListener, plHashHelper<plString>::Hash(value.m_sName));
PL_DECLARE_AUDIOSYSTEM_REQUEST(plAudioSystemRequestSetListenerTransform, plHashHelper<plAudioSystemTransform>::Hash(value.m_Transform));
PL_DECLARE_AUDIOSYSTEM_REQUEST_SIMPLE(plAudioSystemRequestUnregisterListener);
PL_DECLARE_AUDIOSYSTEM_REQUEST(plAudioSystemRequestLoadTrigger, plHashHelper<plAudioSystemDataID>::Hash(value.m_uiEventId));
PL_DECLARE_AUDIOSYSTEM_REQUEST(plAudioSystemRequestActivateTrigger, plHashHelper<plAudioSystemDataID>::Hash(value.m_uiEventId));
PL_DECLARE_AUDIOSYSTEM_REQUEST(plAudioSystemRequestStopEvent, plHashHelper<plAudioSystemDataID>::Hash(value.m_uiTriggerId));
PL_DECLARE_AUDIOSYSTEM_REQUEST_SIMPLE(plAudioSystemRequestUnloadTrigger);
PL_DECLARE_AUDIOSYSTEM_REQUEST(plAudioSystemRequestSetRtpcValue, plHashHelper<plInt32>::Hash(plMath::FloatToInt(value.m_fValue * 1000.0f)));
PL_DECLARE_AUDIOSYSTEM_REQUEST_SIMPLE(plAudioSystemRequestSetSwitchState);
PL_DECLARE_AUDIOSYSTEM_REQUEST(plAudioSystemRequestSetEnvironmentAmount, plHashHelper<plInt32>::Hash(plMath::FloatToInt(value.m_fAmount * 1000.0f)));
PL_DECLARE_AUDIOSYSTEM_REQUEST(plAudioSystemRequestSetObstructionOcclusion, plHashHelper<plInt32>::Hash(plMath::FloatToInt(value.m_fObstruction * 1000.0f)) * plHashHelper<plInt32>::Hash(plMath::FloatToInt(value.m_fOcclusion * 1000.0f)));
PL_DECLARE_AUDIOSYSTEM_REQUEST_SIMPLE(plAudioSystemRequestLoadBank);
PL_DECLARE_AUDIOSYSTEM_REQUEST_SIMPLE(plAudioSystemRequestUnloadBank);
PL_DECLARE_AUDIOSYSTEM_REQUEST_SIMPLE(plAudioSystemRequestShutdown);
...
struct CallRequestCallbackFunc
{
  ...
  template <typename T>
  PL_ALWAYS_INLINE void Call() const
  {
