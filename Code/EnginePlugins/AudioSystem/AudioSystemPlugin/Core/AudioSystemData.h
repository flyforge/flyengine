...
struct PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioSystemTransform
{
...
{
  PLASMA_ALWAYS_INLINE static plUInt32 Hash(const plAudioSystemTransform& value)
  {
  ...
  PLASMA_ALWAYS_INLINE static bool Equal(const plAudioSystemTransform& a, const plAudioSystemTransform& b)
  {
    return a == b;
  }
};

PLASMA_DECLARE_REFLECTABLE_TYPE(PLASMA_AUDIOSYSTEMPLUGIN_DLL, plAudioSystemTransform);

/// \brief The obstruction type applied to a sound. This affects the way that
/// ray casting works for an audio source.
struct PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioSystemSoundObstructionType
{
  ...
  PLASMA_ENUM_TO_STRING(None, SingleRay, MultipleRay);
};

PLASMA_DECLARE_REFLECTABLE_TYPE(PLASMA_AUDIOSYSTEMPLUGIN_DLL, plAudioSystemSoundObstructionType);

/// \brief The state of an audio trigger.
struct PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioSystemTriggerState
{
  using StorageType = plUInt8;
  ...
  PLASMA_ENUM_TO_STRING(Invalid, Playing, Ready, Loading, Unloading, Starting, Stopping, Stopped);
};

PLASMA_DECLARE_REFLECTABLE_TYPE(PLASMA_AUDIOSYSTEMPLUGIN_DLL, plAudioSystemTriggerState);
...
class PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioSystemEntityData : public plReflectedClass
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioSystemEntityData, plReflectedClass);
...
class PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioSystemListenerData : public plReflectedClass
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioSystemListenerData, plReflectedClass);
...
class PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioSystemTriggerData : public plReflectedClass
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioSystemTriggerData, plReflectedClass);
...
class PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioSystemRtpcData : public plReflectedClass
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioSystemRtpcData, plReflectedClass);
...
class PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioSystemSwitchStateData : public plReflectedClass
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioSystemSwitchStateData, plReflectedClass);
...
class PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioSystemEnvironmentData : public plReflectedClass
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioSystemEnvironmentData, plReflectedClass);
...
class PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioSystemEventData : public plReflectedClass
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioSystemEventData, plReflectedClass);

  ~plAudioSystemEventData() override = default;
};

/// \brief Base class for an audio middleware source.
class PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioSystemSourceData : public plReflectedClass
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioSystemSourceData, plReflectedClass);
...
class PLASMA_AUDIOSYSTEMPLUGIN_DLL plAudioSystemBankData : public plReflectedClass
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioSystemBankData, plReflectedClass);
