...
class PL_AUDIOSYSTEMPLUGIN_DLL plAudioSystem final : public plSoundInterface
{
  PL_DECLARE_SINGLETON_OF_INTERFACE(plAudioSystem, plSoundInterface);
...
public:
  ...
  PL_NODISCARD bool IsInitialized() const;
...
private:
  PL_MAKE_SUBSYSTEM_STARTUP_FRIEND(AudioSystem, AudioSystemPlugin);
