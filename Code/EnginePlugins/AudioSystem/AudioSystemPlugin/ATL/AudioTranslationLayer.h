...
class PL_AUDIOSYSTEMPLUGIN_DLL plAudioTranslationLayer
{
  PL_DISALLOW_COPY_AND_ASSIGN(plAudioTranslationLayer);
...
public:
  ...
  /// is not registered.
  PL_NODISCARD plAudioSystemDataID GetTriggerId(plStringView sTriggerName) const;
  ...
  PL_NODISCARD plAudioSystemDataID GetRtpcId(plStringView sRtpcName) const;
  ...
  /// is not registered.
  PL_NODISCARD plAudioSystemDataID GetSwitchStateId(plStringView sSwitchStateName) const;
  ...
  /// is not registered.
  PL_NODISCARD plAudioSystemDataID GetEnvironmentId(plStringView sEnvironmentName) const;
