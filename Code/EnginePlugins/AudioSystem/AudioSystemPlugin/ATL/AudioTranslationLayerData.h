...
public:
  ...
  PLASMA_NODISCARD virtual plAudioSystemDataID GetId() const { return m_uiId; }
...
public:
  ...
  PLASMA_NODISCARD plResult GetEvent(plAudioSystemDataID uiEventId, plAudioSystemEventData*& out_pEventData) const;
