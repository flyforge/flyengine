...
class PL_EDITORENGINEPROCESSFRAMEWORK_DLL plEditorProcessViewWindow : public plWindowBase
{
public:
...
class PL_EDITORENGINEPROCESSFRAMEWORK_DLL plEngineProcessViewContext
{
public:
