...
// clang-format off
PLASMA_BEGIN_DYNAMIC_REFLECTED_TYPE(plEditorPreferencesUser, 1, plRTTIDefaultAllocator<plEditorPreferencesUser>)
{
  PLASMA_BEGIN_PROPERTIES
  {
    ...
    PLASMA_MEMBER_PROPERTY("MaxFramerate", m_uiMaxFramerate)->AddAttributes(new plDefaultValueAttribute(60)),
    ...
    PLASMA_MEMBER_PROPERTY("RotationSnap", m_RotationSnapValue)->AddAttributes(new plDefaultValueAttribute(plAngle::MakeFromDegree(15.0f)), new plHiddenAttribute()),
    PLASMA_MEMBER_PROPERTY("ScaleSnap", m_fScaleSnapValue)->AddAttributes(new plDefaultValueAttribute(0.125f), new plHiddenAttribute()),
    PLASMA_MEMBER_PROPERTY("TranslationSnap", m_fTranslationSnapValue)->AddAttributes(new plDefaultValueAttribute(0.25f), new plHiddenAttribute()),
    ...
    PLASMA_MEMBER_PROPERTY("DirectionalLightAngle", m_DirectionalLightAngle)->AddAttributes(new plDefaultValueAttribute(plAngle::MakeFromDegree(30.0f)), new plClampValueAttribute(plAngle::MakeFromDegree(-90.0f), plAngle::MakeFromDegree(90.0f))),
