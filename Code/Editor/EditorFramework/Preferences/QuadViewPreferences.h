...
struct PL_EDITORFRAMEWORK_DLL plEngineViewPreferences
{
...
PL_DECLARE_REFLECTABLE_TYPE(PL_EDITORFRAMEWORK_DLL, plEngineViewPreferences);

class PL_EDITORFRAMEWORK_DLL plQuadViewPreferencesUser : public plPreferences
{
  PL_ADD_DYNAMIC_REFLECTION(plQuadViewPreferencesUser, plPreferences);
