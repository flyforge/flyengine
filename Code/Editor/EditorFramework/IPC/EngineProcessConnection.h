...
class PLASMA_EDITORFRAMEWORK_DLL plEditorEngineProcessConnection
{
  PLASMA_DECLARE_SINGLETON(plEditorEngineProcessConnection);
...
class PLASMA_EDITORFRAMEWORK_DLL plEditorEngineConnection
{
public:
