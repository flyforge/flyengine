  ...
  : plQtStandardPropertyWidget()
{
  ...
  PL_VERIFY(connect(m_pMenu, SIGNAL(aboutToShow()), this, SLOT(on_Menu_aboutToShow())), "show connection failed");
  PL_VERIFY(connect(m_pMenu, SIGNAL(aboutToHide()), this, SLOT(on_Menu_aboutToHide())), "hide connection failed");
}
