...
class PLASMA_EDITORFRAMEWORK_DLL plQtAssetCuratorFilter : public plQtAssetFilter
{
  Q_OBJECT
public:
...
class PLASMA_EDITORFRAMEWORK_DLL plQtAssetCuratorPanel : public plQtApplicationPanel, public Ui_AssetCuratorPanel
{
  Q_OBJECT

  PLASMA_DECLARE_SINGLETON(plQtAssetCuratorPanel);
