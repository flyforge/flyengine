...
PL_IMPLEMENT_SINGLETON(plQtAssetBrowserPanel);
  ...
  , m_SingletonRegistrar(this)
{
  ...
  PL_VERIFY(connect(AssetBrowserWidget, &plQtAssetBrowserWidget::ItemChosen, this, &plQtAssetBrowserPanel::SlotAssetChosen) != nullptr,
    "signal/slot connection failed");
  PL_VERIFY(connect(AssetBrowserWidget, &plQtAssetBrowserWidget::ItemSelected, this, &plQtAssetBrowserPanel::SlotAssetSelected) != nullptr,
    "signal/slot connection failed");
  PL_VERIFY(connect(AssetBrowserWidget, &plQtAssetBrowserWidget::ItemCleared, this, &plQtAssetBrowserPanel::SlotAssetCleared) != nullptr,
    "signal/slot connection failed");
...
void plQtAssetBrowserPanel::SlotAssetChosen(plUuid guid, QString sAssetPathRelative, QString sAssetPathAbsolute, plUInt8 uiAssetBrowserItemFlags)
{
  ...
  {
    plQtUiServices::OpenFileInDefaultProgram(qtToPlString(sAssetPathAbsolute));
  }
}
