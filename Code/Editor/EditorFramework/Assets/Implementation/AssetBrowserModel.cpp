...
struct FileComparer
{
  ...
  PL_ALWAYS_INLINE bool operator()(const plQtAssetBrowserModel::VisibleEntry& a, const plQtAssetBrowserModel::VisibleEntry& b) const
  {
    return Less(a, b);
  }
...
plQtAssetBrowserModel::plQtAssetBrowserModel(QObject* pParent, plQtAssetFilter* pFilter)
  ...
  , m_pFilter(pFilter)
{
  PL_ASSERT_DEBUG(pFilter != nullptr, "plQtAssetBrowserModel requires a valid filter.");
  ...
  PL_VERIFY(connect(plQtImageCache::GetSingleton(), &plQtImageCache::ImageLoaded, this, &plQtAssetBrowserModel::ThumbnailLoaded) != nullptr,
    "signal/slot connection failed");
  PL_VERIFY(connect(plQtImageCache::GetSingleton(), &plQtImageCache::ImageInvalidated, this, &plQtAssetBrowserModel::ThumbnailInvalidated) != nullptr,
    "signal/slot connection failed");
