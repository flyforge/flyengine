...
struct plAssetDocumentFlags
{
  ...
  enum Enum
  {
    ...
    SubAssetsSupportThumbnail = PLASMA_BIT(5),         ///< The sub-asset supports thumbnail generation (InternalCreateThumbnail must be implemented).
    SubAssetsAutoThumbnailOnTransform = PLASMA_BIT(6), ///< Thumbnails for sub-assets are automatically generated by the asset transform, and do not need to be explicitly created.
    Default = None
  };
