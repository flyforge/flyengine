...
plResult plTexConv::ParseAssetHeader()
{
  ...
  const plUInt64 uiHashLow = plConversionUtils::ConvertHexStringToUInt32(opt_AssetHashLow.GetOptionValue(plCommandLineOption::LogMode::Always));
  const plUInt64 uiHashHigh = plConversionUtils::ConvertHexStringToUInt32(opt_AssetHashHigh.GetOptionValue(plCommandLineOption::LogMode::Always));
