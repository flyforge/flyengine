...
PL_IMPLEMENT_SINGLETON(plQtImageCache);

// clang-format off
PL_BEGIN_SUBSYSTEM_DECLARATION(GuiFoundation, QtImageCache)

ON_CORESYSTEMS_STARTUP
{
  g_pImageCacheSingleton = PL_DEFAULT_NEW(plQtImageCache);
}

ON_CORESYSTEMS_SHUTDOWN
{
  PL_DEFAULT_DELETE(g_pImageCacheSingleton);
}
