  ...
  const plColor& color, bool bAlpha, bool bHDR, QWidget* pParent, const char* szSlotCurColChanged, const char* szSlotAccept, const char* szSlotReject)
{
  ...
  PLASMA_VERIFY(QWidget::connect(m_pColorDlg, SIGNAL(CurrentColorChanged(const plColor&)), pParent, szSlotCurColChanged) != nullptr,
    "signal/slot connection failed");
  PLASMA_VERIFY(QWidget::connect(m_pColorDlg, SIGNAL(accepted()), pParent, szSlotAccept) != nullptr, "signal/slot connection failed");
  PLASMA_VERIFY(QWidget::connect(m_pColorDlg, SIGNAL(rejected()), pParent, szSlotReject) != nullptr, "signal/slot connection failed");
