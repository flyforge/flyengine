...
class PLASMA_GUIFOUNDATION_DLL plQtUiServices : public QObject
{
  Q_OBJECT

  PLASMA_DECLARE_SINGLETON(plQtUiServices);
...
public:
  ...
  static const QIcon& GetCachedIconResource(const char* szIdentifier, plColor color = plColor::ZeroColor());
