...
class PL_GUIFOUNDATION_DLL plQtImageCache : public QObject
{
  Q_OBJECT

  PL_DECLARE_SINGLETON(plQtImageCache);
...
PL_ALWAYS_INLINE QPixmap plSvgThumbnailToPixmap(const char* szFilePath)
{
