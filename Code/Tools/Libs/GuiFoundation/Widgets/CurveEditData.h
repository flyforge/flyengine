...
PL_DECLARE_REFLECTABLE_TYPE(PL_GUIFOUNDATION_DLL, plCurveTangentMode);
...
class PL_GUIFOUNDATION_DLL plCurveControlPointData : public plReflectedClass
{
  PL_ADD_DYNAMIC_REFLECTION(plCurveControlPointData, plReflectedClass);
...
class PL_GUIFOUNDATION_DLL plSingleCurveData : public plReflectedClass
{
  PL_ADD_DYNAMIC_REFLECTION(plSingleCurveData, plReflectedClass);
...
class PL_GUIFOUNDATION_DLL plCurveExtentsAttribute : public plPropertyAttribute
{
  PL_ADD_DYNAMIC_REFLECTION(plCurveExtentsAttribute, plPropertyAttribute);
...
class PL_GUIFOUNDATION_DLL plCurveGroupData : public plReflectedClass
{
  PL_ADD_DYNAMIC_REFLECTION(plCurveGroupData, plReflectedClass);
...
struct PL_GUIFOUNDATION_DLL plSelectedCurveCP
{
  PL_DECLARE_POD_TYPE();
