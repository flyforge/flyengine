...
void plQtGraphicsView::wheelEvent(QWheelEvent* e)
{
  if (e->angleDelta().y() > 0)
  {
    m_fZoom *= 1.2f;
...
void plQtGraphicsView::mousePressEvent(QMouseEvent* e)
{
...
void plQtGraphicsView::mouseReleaseEvent(QMouseEvent* e)
{
...
void plQtGraphicsView::mouseMoveEvent(QMouseEvent* e)
{
  if (m_bPanning)
  {
...
void plQtGraphicsView::keyPressEvent(QKeyEvent* e)
{
...
void plQtGraphicsView::UpdateTransform()
{
  m_fZoom = plMath::Clamp(m_fZoom, m_fMinZoom, m_fMaxZoom);
