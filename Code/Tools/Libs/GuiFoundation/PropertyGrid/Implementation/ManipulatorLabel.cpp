...
plQtManipulatorLabel::plQtManipulatorLabel(QWidget* pParent, Qt::WindowFlags f)
  : QLabel(pParent, f)
  , m_pItems(nullptr)
...
plQtManipulatorLabel::plQtManipulatorLabel(const QString& sText, QWidget* pParent, Qt::WindowFlags f)
