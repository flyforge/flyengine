...
void plQtTreeSearchFilterModel::SetIncludeChildren(bool bInclude)
{
...
void plQtTreeSearchFilterModel::RecomputeVisibleItems()
{
...
bool plQtTreeSearchFilterModel::UpdateVisibility(const QModelIndex& idx, bool bParentIsVisible)
{
  bool bExisted = false;
...
bool plQtTreeSearchFilterModel::filterAcceptsRow(int source_row, const QModelIndex& source_parent) const
{
