...
{
  s_hMenuProject = PL_REGISTER_MENU("G.Project");
  s_hMenuFile = PL_REGISTER_MENU("G.File");
  s_hMenuEdit = PL_REGISTER_MENU("G.Edit");
  s_hMenuPanels = PL_REGISTER_DYNAMIC_MENU("G.Panels", plApplicationPanelsMenuAction, "");
  s_hMenuScene = PL_REGISTER_MENU("G.Scene");
  s_hMenuView = PL_REGISTER_MENU("G.View");
  s_hMenuTools = PL_REGISTER_MENU("G.Tools");
  s_hMenuHelp = PL_REGISTER_MENU("G.Help");
  s_hCheckForUpdates = PL_REGISTER_ACTION_1("Help.CheckForUpdates", plActionScope::Global, "Help", "", plHelpActions, plHelpActions::ButtonType::CheckForUpdates);
  s_hReportProblem = PL_REGISTER_ACTION_1("Help.ReportProblem", plActionScope::Global, "Help", "", plHelpActions, plHelpActions::ButtonType::ReportProblem);
}
...
void plStandardMenus::MapActions(plStringView sMapping, const plBitflags<plStandardMenuTypes>& menus)
{
  ...
  PL_ASSERT_DEV(pMap != nullptr, "'{0}' does not exist", sMapping);
...
// clang-format off
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plApplicationPanelsMenuAction, 1, plRTTINoAllocator)
...
struct plComparePanels
{
  ...
  PL_ALWAYS_INLINE bool Less(const plDynamicMenuAction::Item& p1, const plDynamicMenuAction::Item& p2) const { return p1.m_sDisplay < p2.m_sDisplay; }

  /// \brief Returns true if a is equal to b
  PL_ALWAYS_INLINE bool Equal(const plDynamicMenuAction::Item& p1, const plDynamicMenuAction::Item& p2) const
  {
...
// clang-format off
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plHelpActions, 1, plRTTINoAllocator)
PL_END_DYNAMIC_REFLECTED_TYPE;
// clang-format on
