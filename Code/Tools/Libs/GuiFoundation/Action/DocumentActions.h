...
///
class PL_GUIFOUNDATION_DLL plDocumentActions
{
public:
...
class PL_GUIFOUNDATION_DLL plDocumentAction : public plButtonAction
{
  PL_ADD_DYNAMIC_REFLECTION(plDocumentAction, plButtonAction);
