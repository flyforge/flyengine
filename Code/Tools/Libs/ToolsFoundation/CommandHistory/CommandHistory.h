...
class PL_TOOLSFOUNDATION_DLL plCommandTransaction : public plCommand
{
  PL_ADD_DYNAMIC_REFLECTION(plCommandTransaction, plCommand);
...
class PL_TOOLSFOUNDATION_DLL plCommandHistory
{
public:
