...
class PL_TOOLSFOUNDATION_DLL plObjectChange
{
public:
...
PL_DECLARE_REFLECTABLE_TYPE(PL_TOOLSFOUNDATION_DLL, plObjectChange);


class PL_TOOLSFOUNDATION_DLL plDocumentObjectMirror
{
public:
