...
// clang-format off
PLASMA_BEGIN_DYNAMIC_REFLECTED_TYPE(plLongOpProxy_BuildNavMesh, 1, plRTTIDefaultAllocator<plLongOpProxy_BuildNavMesh>)
...
void plLongOpProxy_BuildNavMesh::GetReplicationInfo(plStringBuilder& out_sReplicationOpType, plStreamWriter& description)
{
...

  {
    ...
    sOutputFile.Format(":project/AssetCache/Generated/{0}.plRecastNavMesh", sComponentGuid);
