...
plQtTypeScriptAssetDocumentWindow::plQtTypeScriptAssetDocumentWindow(plAssetDocument* pDocument)
  : plQtDocumentWindow(pDocument)
{
  ...
  m_pAssetDoc = static_cast<plTypeScriptAssetDocument*>(pDocument);
...
//    font.setPointSize(10);
  ...
  m_pAssetDoc->GetEvent().AddEventHandler(plMakeDelegate(&plQtTypeScriptAssetDocumentWindow::TsDocumentEventHandler, this));
}

plQtTypeScriptAssetDocumentWindow::~plQtTypeScriptAssetDocumentWindow()
{
  m_pAssetDoc->GetEvent().RemoveEventHandler(plMakeDelegate(&plQtTypeScriptAssetDocumentWindow::TsDocumentEventHandler, this));

  delete m_pHighlighter;
}

void plQtTypeScriptAssetDocumentWindow::UpdateFileContentDisplay()
{
...
void plQtTypeScriptAssetDocumentWindow::TsDocumentEventHandler(const plTypeScriptAssetDocumentEvent& e)
{
  switch (e.m_Type)
  {
    case plTypeScriptAssetDocumentEvent::Type::ScriptCreated:
    case plTypeScriptAssetDocumentEvent::Type::ScriptOpened:
    case plTypeScriptAssetDocumentEvent::Type::ScriptTransformed:
      UpdateFileContentDisplay();
      break;
