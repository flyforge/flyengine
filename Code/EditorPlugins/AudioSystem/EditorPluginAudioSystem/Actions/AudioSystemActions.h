...
class PLASMA_EDITORPLUGINAUDIOSYSTEM_DLL plAudioSystemActions
{
public:
...
class PLASMA_EDITORPLUGINAUDIOSYSTEM_DLL plAudioSystemAction : public plButtonAction
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioSystemAction, plButtonAction);
...
class PLASMA_EDITORPLUGINAUDIOSYSTEM_DLL plAudioSystemSliderAction : public plSliderAction
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioSystemSliderAction, plSliderAction);
