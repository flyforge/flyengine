...
class PLASMA_EDITORPLUGINAUDIOSYSTEM_DLL plAudioSystemProjectPreferences : public plPreferences
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plAudioSystemProjectPreferences, plPreferences);
...
public:
  ...
  PLASMA_NODISCARD bool GetMute() const { return m_bMute; }
  ...
  PLASMA_NODISCARD float GetGain() const { return m_fGain; }
