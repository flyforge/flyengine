...
class PL_EDITORPLUGINASSETS_DLL plTextureAssetProfileConfig : public plProfileConfigData
{
  PL_ADD_DYNAMIC_REFLECTION(plTextureAssetProfileConfig, plProfileConfigData);
...
{
  PL_ADD_DYNAMIC_REFLECTION(plTextureAssetDocumentManager, plAssetDocumentManager);
