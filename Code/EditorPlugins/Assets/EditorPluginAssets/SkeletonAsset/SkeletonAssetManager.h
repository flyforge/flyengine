...
class plSkeletonAssetDocumentManager : public plAssetDocumentManager
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plSkeletonAssetDocumentManager, plAssetDocumentManager);

public:
  plSkeletonAssetDocumentManager();
  ~plSkeletonAssetDocumentManager();
