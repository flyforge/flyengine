...
// clang-format off
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plCollectionAssetEntry, 1, plRTTIDefaultAllocator<plCollectionAssetEntry>)
{
  PL_BEGIN_PROPERTIES
  {
    PL_MEMBER_PROPERTY("Name", m_sLookupName),
    PL_MEMBER_PROPERTY("Asset", m_sRedirectionAsset)->AddAttributes(new plAssetBrowserAttribute("", plDependencyFlags::Package))
  }
  PL_END_PROPERTIES;
}
PL_END_DYNAMIC_REFLECTED_TYPE;

PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plCollectionAssetData, 1, plRTTIDefaultAllocator<plCollectionAssetData>)
{
  PL_BEGIN_PROPERTIES
  {
...
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plCollectionAssetDocument, 1, plRTTINoAllocator)
PL_END_DYNAMIC_REFLECTED_TYPE;
// clang-format on
