...
// clang-format off
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plLUTAssetDocument, 1, plRTTINoAllocator)
...
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plLUTAssetDocumentGenerator, 1, plRTTIDefaultAllocator<plLUTAssetDocumentGenerator>)
PL_END_DYNAMIC_REFLECTED_TYPE;
