...
class plRenderPipelineAssetManager : public plAssetDocumentManager
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plRenderPipelineAssetManager, plAssetDocumentManager);

public:
  plRenderPipelineAssetManager();
  ~plRenderPipelineAssetManager();
