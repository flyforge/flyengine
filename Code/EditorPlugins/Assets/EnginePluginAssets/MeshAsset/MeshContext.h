...
class PL_ENGINEPLUGINASSETS_DLL plMeshContext : public plEngineProcessDocumentContext
{
  PL_ADD_DYNAMIC_REFLECTION(plMeshContext, plEngineProcessDocumentContext);
