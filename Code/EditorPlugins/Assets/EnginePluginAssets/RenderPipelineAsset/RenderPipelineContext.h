...
PL_DECLARE_REFLECTABLE_TYPE(PL_NO_LINKAGE, plRenderPipelineContextLoaderConnection);
...
class PL_ENGINEPLUGINASSETS_DLL plRenderPipelineContext : public plEngineProcessDocumentContext
{
  PL_ADD_DYNAMIC_REFLECTION(plRenderPipelineContext, plEngineProcessDocumentContext);
