...
class PLASMA_ENGINEPLUGINASSETS_DLL plSkeletonContext : public plEngineProcessDocumentContext
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plSkeletonContext, plEngineProcessDocumentContext);
