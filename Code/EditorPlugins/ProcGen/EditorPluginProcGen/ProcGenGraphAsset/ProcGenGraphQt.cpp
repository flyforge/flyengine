...
void plQtProcGenPin::ExtendContextMenu(QMenu& menu)
{
...
void plQtProcGenPin::keyPressEvent(QKeyEvent* event)
{
...
void plQtProcGenPin::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget* widget)
{
  plQtPin::paint(painter, option, widget);
...
plQtProcGenScene::plQtProcGenScene(QObject* parent /*= nullptr*/)
