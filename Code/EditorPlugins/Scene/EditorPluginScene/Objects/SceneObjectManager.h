...
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plSceneDocumentSettingsBase, plReflectedClass);
};

class plPrefabDocumentSettings : public plSceneDocumentSettingsBase
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plPrefabDocumentSettings, plSceneDocumentSettingsBase);
...
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plLayerDocumentSettings, plSceneDocumentSettingsBase);
};

class plSceneDocumentRoot : public plDocumentRoot
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plSceneDocumentRoot, plDocumentRoot);
