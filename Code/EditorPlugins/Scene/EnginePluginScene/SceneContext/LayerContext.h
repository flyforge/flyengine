...
class PLASMA_ENGINEPLUGINSCENE_DLL plLayerContext : public plEngineProcessDocumentContext
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plLayerContext, plEngineProcessDocumentContext);
