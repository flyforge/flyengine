...
class PL_ENGINEPLUGINSCENE_DLL plSceneContext : public plEngineProcessDocumentContext
{
  PL_ADD_DYNAMIC_REFLECTION(plSceneContext, plEngineProcessDocumentContext);
