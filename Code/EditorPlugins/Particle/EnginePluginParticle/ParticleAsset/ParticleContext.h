...
class PLASMA_ENGINEPLUGINPARTICLE_DLL plParticleContext : public plEngineProcessDocumentContext
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plParticleContext, plEngineProcessDocumentContext);
