...
class PL_RENDERERDX11_DLL plGALCommandEncoderImplDX11 final : public plGALCommandEncoderCommonPlatformInterface, public plGALCommandEncoderRenderPlatformInterface, public plGALCommandEncoderComputePlatformInterface
{
public:
...
private:
  ...
  ID3D11SamplerState* m_pBoundSamplerStates[plGALShaderStage::ENUM_COUNT][PL_GAL_MAX_SAMPLER_COUNT] = {};
  ...
  ID3D11RenderTargetView* m_pBoundRenderTargets[PL_GAL_MAX_RENDERTARGET_COUNT] = {};
  plUInt32 m_uiBoundRenderTargetCount = 0;
  ID3D11DepthStencilView* m_pBoundDepthStencilTarget = nullptr;

  ID3D11Buffer* m_pBoundVertexBuffers[PL_GAL_MAX_VERTEX_BUFFER_COUNT] = {};
  plGAL::ModifiedRange m_BoundVertexBuffersRange;

  plUInt32 m_VertexBufferStrides[PL_GAL_MAX_VERTEX_BUFFER_COUNT] = {};
  plUInt32 m_VertexBufferOffsets[PL_GAL_MAX_VERTEX_BUFFER_COUNT] = {};
};
