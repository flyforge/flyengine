...
/// It ALSO allows to construct the plLuaWrapper with a working lua_State-Pointer and thus
...
public:
  ...
  ///   log.
  plResult ExecuteString(const char* szString, const char* szDebugChunkName = "chunk",
    plLogInterface* pLogInterface = nullptr) const; // [tested]
  ...
  plResult OpenTableFromParameter(plUInt32 uiFunctionParameter); // [tested]
  ...
  int GetIntVariable(const char* szName, plInt32 iDefault = 0) const; // [tested]
  ...
  void SetVariable(const char* szName, plInt32 iValue) const; // [tested]
  ...
  /// Sets the Variable with the given name (in scope) with the given value.
  void SetVariable(const char* szName, const char* szValue, plUInt32 uiLen) const; // [tested]
  ...
  /// }
  /// \endcode
  plInt32 ReturnToScript() const; // [tested]
  ...
  void PushParameter(plInt32 iParam); // [tested]
  ...
  /// Pushes a parameter on the stack to be passed to the next function called.
  /// Do this after PrepareFunctionCall() and before CallPreparedFunction().
  void PushParameter(const char* szParam, plUInt32 uiLength); // [tested]
  ...
  plUInt32 GetNumberOfFunctionParameters() const; // [tested]

  /// Checks the nth Parameter passed to a C-Function for its type.
  bool IsParameterInt(plUInt32 uiParameter) const; // [tested]

  /// Checks the nth Parameter passed to a C-Function for its type.
  bool IsParameterBool(plUInt32 uiParameter) const; // [tested]

  /// Checks the nth Parameter passed to a C-Function for its type.
  bool IsParameterFloat(plUInt32 uiParameter) const; // [tested]

  /// Checks the nth Parameter passed to a C-Function for its type.
  bool IsParameterTable(plUInt32 uiParameter) const; // [tested]

  /// Checks the nth Parameter passed to a C-Function for its type.
  bool IsParameterString(plUInt32 uiParameter) const; // [tested]

  /// Checks the nth Parameter passed to a C-Function for its type.
  bool IsParameterNil(plUInt32 uiParameter) const; // [tested]

  /// Returns the Value of the nth Parameter.
  int GetIntParameter(plUInt32 uiParameter) const; // [tested]

  /// Returns the Value of the nth Parameter.
  bool GetBoolParameter(plUInt32 uiParameter) const; // [tested]

  /// Returns the Value of the nth Parameter.
  float GetFloatParameter(plUInt32 uiParameter) const; // [tested]

  /// Returns the Value of the nth Parameter.
  const char* GetStringParameter(plUInt32 uiParameter) const; // [tested]
  ...
  void PushReturnValue(plInt32 iParam); // [tested]
  ...
  /// Pushes a value as a return value for a called C-Function
  void PushReturnValue(const char* szParam, plUInt32 uiLength); // [tested]
  ...
  bool IsReturnValueInt(plUInt32 uiReturnValue) const; // [tested]

  /// Checks the nth return-value passed to a C-Function for its type.
  bool IsReturnValueBool(plUInt32 uiReturnValue) const; // [tested]

  /// Checks the nth return-value passed to a C-Function for its type.
  bool IsReturnValueFloat(plUInt32 uiReturnValue) const; // [tested]

  /// Checks the nth return-value passed to a C-Function for its type.
  bool IsReturnValueString(plUInt32 uiReturnValue) const; // [tested]

  /// Checks the nth return-value passed to a C-Function for its type.
  bool IsReturnValueNil(plUInt32 uiReturnValue) const; // [tested]


  /// Returns the value of the nth return-value.
  int GetIntReturnValue(plUInt32 uiReturnValue) const; // [tested]

  /// Returns the value of the nth return-value.
  bool GetBoolReturnValue(plUInt32 uiReturnValue) const; // [tested]

  /// Returns the value of the nth return-value.
  float GetFloatReturnValue(plUInt32 uiReturnValue) const; // [tested]

  /// Returns the value of the nth return-value.
  const char* GetStringReturnValue(plUInt32 uiReturnValue) const; // [tested]
