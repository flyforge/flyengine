...
// clang-format off
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plCustomData, 1, plRTTINoAllocator)
...
// clang-format off
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plCustomDataResourceBase, 1, plRTTINoAllocator)
PL_END_DYNAMIC_REFLECTED_TYPE;
// clang-format on
...
PL_STATICLINK_FILE(Core, Core_Utils_Implementation_CustomData);
