...
static plTime s_Intervals[] = {
  plTime::Zero(),              // EveryFrame
  plTime::Seconds(1.0 / 30.0), // Max30fps
  plTime::Seconds(1.0 / 20.0), // Max20fps
  plTime::Seconds(1.0 / 10.0), // Max10fps
  plTime::Seconds(1.0 / 5.0),  // Max5fps
  plTime::Seconds(1.0 / 2.0),  // Max2fps
  plTime::Seconds(1.0 / 1.0),  // Max1fps
};
