...
#  define PLASMA_SUPPORTS_DIRECTXTEX PLASMA_ON
#else
#  define PLASMA_SUPPORTS_DIRECTXTEX PLASMA_OFF
#endif

#if PLASMA_ENABLED(PLASMA_SUPPORTS_DIRECTXTEX)
...
// clang-format off
PLASMA_BEGIN_SUBSYSTEM_DECLARATION(TexConv, DXTexConversions)
...
PLASMA_STATICLINK_FILE(Texture, Texture_Image_Conversions_DXTexConversions);
