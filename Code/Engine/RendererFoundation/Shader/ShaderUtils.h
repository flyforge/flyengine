...
{
public:
  PL_ALWAYS_INLINE static plUInt32 Float3ToRGB10(plVec3 value)
  {
  ...
  PL_ALWAYS_INLINE static plUInt32 PackFloat16intoUint(plFloat16 x, plFloat16 y)
  {
  ...
  PL_ALWAYS_INLINE static plUInt32 Float2ToRG16F(plVec2 value)
  {
  ...
  PL_ALWAYS_INLINE static void Float4ToRGBA16F(plVec4 value, plUInt32& out_uiRG, plUInt32& out_uiBA)
  {
  ...
  PL_RENDERERFOUNDATION_DLL static plDelegate<void(plBuiltinShaderType type, plBuiltinShader& out_shader)> g_RequestBuiltinShaderCallback;

  PL_ALWAYS_INLINE static void RequestBuiltinShader(plBuiltinShaderType type, plBuiltinShader& out_shader)
  {
    g_RequestBuiltinShaderCallback(type, out_shader);
  }
};
PL_DEFINE_AS_POD_TYPE(plShaderUtils::plBuiltinShaderType);
