...
public:
  ...
  PLASMA_ALWAYS_INLINE plShaderMat3() = default;

  PLASMA_ALWAYS_INLINE plShaderMat3(const plMat3& m) { *this = m; }

  PLASMA_FORCE_INLINE void operator=(const plMat3& m)
  {
...
public:
  ...
  PLASMA_ALWAYS_INLINE plShaderTransform() = default;
...
public:
  ...
  PLASMA_ALWAYS_INLINE plShaderBool() = default;

  PLASMA_ALWAYS_INLINE plShaderBool(bool b) { m_uiData = b ? 0xFFFFFFFF : 0; }

  PLASMA_ALWAYS_INLINE void operator=(bool b) { m_uiData = b ? 0xFFFFFFFF : 0; }
