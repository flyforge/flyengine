...
class PLASMA_RENDERERFOUNDATION_DLL plGALSharedTextureSwapChain : public plGALSwapChain
{
...
PLASMA_DECLARE_REFLECTABLE_TYPE(PLASMA_RENDERERFOUNDATION_DLL, plGALSharedTextureSwapChain);
