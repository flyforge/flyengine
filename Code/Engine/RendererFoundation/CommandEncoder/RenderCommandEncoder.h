...
class PLASMA_RENDERERFOUNDATION_DLL plGALRenderCommandEncoder : public plGALCommandEncoder
{
public:
  ...
  void Draw(plUInt32 uiVertexCount, plUInt32 uiStartVertex);
  void DrawIndexed(plUInt32 uiIndexCount, plUInt32 uiStartIndex);
  void DrawIndexedInstanced(plUInt32 uiIndexCountPerInstance, plUInt32 uiInstanceCount, plUInt32 uiStartIndex);
