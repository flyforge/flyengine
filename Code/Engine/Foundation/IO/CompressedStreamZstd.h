...
class PL_FOUNDATION_DLL plCompressedStreamReaderZstd : public plStreamReader
{
public:
...
class PL_FOUNDATION_DLL plCompressedStreamWriterZstd final : public plStreamWriter
{
public:
