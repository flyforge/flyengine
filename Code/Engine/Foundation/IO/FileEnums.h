...
struct plFileShareMode
{
  enum Enum
  {
    Default,     ///< Results in 'Exclusive' when requesting write access and 'SharedReads' when requesting read access. See plFileOpenMode::Enum.
