...
PL_ALWAYS_INLINE plSimdBBoxSphere::plSimdBBoxSphere() = default;

PL_ALWAYS_INLINE plSimdBBoxSphere::plSimdBBoxSphere(const plSimdVec4f& vCenter, const plSimdVec4f& vBoxHalfExtents, const plSimdFloat& fSphereRadius)
...
PL_ALWAYS_INLINE plSimdBBoxSphere::plSimdBBoxSphere(const plSimdBSphere& sphere)
  : m_CenterAndRadius(sphere.m_CenterAndRadius)
  , m_BoxHalfExtents(plSimdVec4f(sphere.GetRadius()))
{
}

PL_ALWAYS_INLINE plSimdBBoxSphere plSimdBBoxSphere::MakeZero()
{
...
PL_ALWAYS_INLINE plSimdBBoxSphere plSimdBBoxSphere::MakeInvalid()
{
  plSimdBBoxSphere res;
...
PL_ALWAYS_INLINE plSimdBBoxSphere plSimdBBoxSphere::MakeFromCenterExtents(const plSimdVec4f& vCenter, const plSimdVec4f& vBoxHalfExtents, const plSimdFloat& fSphereRadius)
{
  plSimdBBoxSphere res;
...
PL_ALWAYS_INLINE plSimdBBoxSphere plSimdBBoxSphere::MakeFromBox(const plSimdBBox& box)
{
  return plSimdBBoxSphere(box);
}

PL_ALWAYS_INLINE plSimdBBoxSphere plSimdBBoxSphere::MakeFromSphere(const plSimdBSphere& sphere)
{
  return plSimdBBoxSphere(sphere);
}

PL_ALWAYS_INLINE plSimdBBoxSphere plSimdBBoxSphere::MakeFromBoxAndSphere(const plSimdBBox& box, const plSimdBSphere& sphere)
{
  plSimdBBoxSphere res;
  res.m_CenterAndRadius = box.GetCenter();
  res.m_BoxHalfExtents = res.m_CenterAndRadius - box.m_Min;
...
PL_ALWAYS_INLINE void plSimdBBoxSphere::SetFromPoints(const plSimdVec4f* pPoints, plUInt32 uiNumPoints, plUInt32 uiStride)
{
  *this = MakeFromPoints(pPoints, uiNumPoints, uiStride);
}

PL_ALWAYS_INLINE plSimdBBox plSimdBBoxSphere::GetBox() const
{
  return plSimdBBox::MakeFromCenterAndHalfExtents(m_CenterAndRadius, m_BoxHalfExtents);
}

PL_ALWAYS_INLINE plSimdBSphere plSimdBBoxSphere::GetSphere() const
{
...
PL_ALWAYS_INLINE void plSimdBBoxSphere::Transform(const plSimdTransform& t)
{
  Transform(t.GetAsMat4());
}

PL_ALWAYS_INLINE void plSimdBBoxSphere::Transform(const plSimdMat4f& mMat)
{
...
PL_ALWAYS_INLINE bool plSimdBBoxSphere::operator==(const plSimdBBoxSphere& rhs) const
{
