...
// static
PLASMA_FORCE_INLINE plSimdVec4u plSimdRandom::UInt(const plSimdVec4i& vPosition, const plSimdVec4u& vSeed /*= plSimdVec4u::MakeZero()*/)
{
...
// static
PLASMA_ALWAYS_INLINE plSimdVec4f plSimdRandom::FloatZeroToOne(const plSimdVec4i& vPosition, const plSimdVec4u& vSeed /*= plSimdVec4u::MakeZero()*/)
{
  return UInt(vPosition, vSeed).ToFloat() * (1.0f / 4294967296.0f);
}

// static
PLASMA_ALWAYS_INLINE plSimdVec4f plSimdRandom::FloatMinMax(const plSimdVec4i& vPosition, const plSimdVec4f& vMinValue, const plSimdVec4f& vMaxValue, const plSimdVec4u& vSeed /*= plSimdVec4u::MakeZero()*/)
{
