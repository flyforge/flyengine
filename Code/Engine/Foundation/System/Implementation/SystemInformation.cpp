...
plSystemInformation plSystemInformation::s_SystemInformation;
...
PLASMA_STATICLINK_FILE(Foundation, Foundation_System_Implementation_SystemInformation);
