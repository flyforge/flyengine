...
template <typename ValueType, typename IteratorType>
PLASMA_FORCE_INLINE void plRangeView<ValueType, IteratorType>::ConstIterator::Next()
{
  this->m_pView->m_Next(this->m_Pos);
}

template <typename ValueType, typename IteratorType>
PLASMA_FORCE_INLINE ValueType plRangeView<ValueType, IteratorType>::ConstIterator::Value() const
{
  return this->m_pView->m_Value(this->m_Pos);
}

template <typename ValueType, typename IteratorType>
PLASMA_FORCE_INLINE bool plRangeView<ValueType, IteratorType>::ConstIterator::operator==(
...
template <typename ValueType, typename IteratorType>
PLASMA_FORCE_INLINE plRangeView<ValueType, IteratorType>::ConstIterator::ConstIterator(const plRangeView<ValueType, IteratorType>* view, IteratorType pos)
{
  m_pView = view;
  m_Pos = pos;
}
...
template <typename ValueType, typename IteratorType>
PLASMA_FORCE_INLINE ValueType plRangeView<ValueType, IteratorType>::Iterator::Value()
{
