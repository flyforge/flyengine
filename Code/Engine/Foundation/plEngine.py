...
def __lldb_init_module(debugger, internal_dict):
    ...
    debugger.HandleCommand('type synthetic add -x "^plDynamicArray<" --python-class plEngine.plDynamicArraySynthProvider')
    debugger.HandleCommand('type synthetic add -x "^plHybridArray<" --python-class plEngine.plHybridArraySynthProvider')
    debugger.HandleCommand('type synthetic add -x "^plHybridString<" --python-class plEngine.plHybridStringSynthProvider')
    debugger.HandleCommand('type synthetic add plStringBuilder --python-class plEngine.plHybridStringSynthProvider')
    debugger.HandleCommand('type synthetic add plStringView --python-class plEngine.plStringViewSynthProvider')
    debugger.HandleCommand('type synthetic add -x "^plEnum<" --python-class plEngine.plEnumSynthProvider')
    debugger.HandleCommand('type synthetic add -x "^plArrayPtr<" --python-class plEngine.plArrayPtrSynthProvider')
    debugger.HandleCommand('type synthetic add plByteArrayPtr --python-class plEngine.plArrayPtrSynthProvider')
    debugger.HandleCommand('type synthetic add plConstByteArrayPtr --python-class plEngine.plArrayPtrSynthProvider')
    debugger.HandleCommand('type synthetic add -x "^plMap<" --python-class plEngine.plMapSynthProvider')

    debugger.HandleCommand('type summary add -x "^plHybridString<" --python-function plEngine.plHybridString_SummaryProvider')
    debugger.HandleCommand('type summary add plStringBuilder --python-function plEngine.plHybridString_SummaryProvider')
    debugger.HandleCommand('type summary add plStringView --python-function plEngine.plStringView_SummaryProvider')
    debugger.HandleCommand('type summary add -x "^plEnum<" --python-function plEngine.plEnum_SummaryProvider')
