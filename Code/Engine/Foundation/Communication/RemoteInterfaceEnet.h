...
class PLASMA_FOUNDATION_DLL plRemoteInterfaceEnet : public plRemoteInterface
{
public:
  ~plRemoteInterfaceEnet();

  /// \brief Allocates a new instance with the given allocator
  static plInternal::NewInstance<plRemoteInterfaceEnet> Make(plAllocatorBase* pAllocator = plFoundation::GetDefaultAllocator());
