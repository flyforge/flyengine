...
/// \brief Do not cast into this class or any of its derived classes, use plAbstractSetProperty instead.
template <typename Type>
class plTypedSetProperty : public plAbstractSetProperty
{
public:
  plTypedSetProperty(const char* szPropertyName)
    : plAbstractSetProperty(szPropertyName)
  {
...
template <>
class plTypedSetProperty<const char*> : public plAbstractSetProperty
{
public:
  plTypedSetProperty(const char* szPropertyName)
    : plAbstractSetProperty(szPropertyName)
...
class plAccessorSetProperty : public plTypedSetProperty<Type>
{
public:
  ...
  virtual void GetValues(const void* pInstance, plDynamicArray<plVariant>& out_keys) const override
  {
    ...
    for (const auto& value : (static_cast<const Class*>(pInstance)->*m_GetValues)())
    {
      out_keys.PushBack(plVariant(value));
    }
  }
...
class plMemberSetProperty : public plTypedSetProperty<typename plTypeTraits<Type>::NonConstReferenceType>
{
public:
  using RealType = typename plTypeTraits<Type>::NonConstReferenceType;
