...
class plTypedMapProperty : public plAbstractMapProperty
{
public:
  plTypedMapProperty(const char* szPropertyName)
...
class plAccessorMapProperty : public plTypedMapProperty<Type>
{
public:
    ...
    : plTypedMapProperty<Type>(szPropertyName)
  {
    ...
    if (m_Insert == nullptr || remove == nullptr)
      plAbstractMapProperty::m_Flags.Add(plPropertyFlags::ReadOnly);
  }
...
template <typename Class, typename Type, typename Container>
class plWriteAccessorMapProperty : public plTypedMapProperty<Type>
{
public:
  using ContainerType = typename plTypeTraits<Container>::NonConstReferenceType;
  using ContainerSubType = typename plContainerSubTypeResolver<ContainerType>::Type;
  using RealType = typename plTypeTraits<Type>::NonConstReferenceType;
...
class plMemberMapProperty : public plTypedMapProperty<typename plTypeTraits<Type>::NonConstReferenceType>
{
public:
  using RealType = typename plTypeTraits<Type>::NonConstReferenceType;
