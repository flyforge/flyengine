...
namespace plMinWindows
{
  ...
  {
    using type = HWND;
    static PLASMA_ALWAYS_INLINE HWND FromNative(::HWND hWnd) { return reinterpret_cast<HWND>(hWnd); }
  };
  ...
  {
    using type = HINSTANCE;
    static PLASMA_ALWAYS_INLINE HINSTANCE FromNative(::HINSTANCE hInstance) { return reinterpret_cast<HINSTANCE>(hInstance); }
  };
} // namespace plMinWindows
#endif
