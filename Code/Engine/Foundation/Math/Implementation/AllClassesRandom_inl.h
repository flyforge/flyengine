...
plVec3Template<Type> plVec3Template<Type>::MakeRandomPointInSphere(plRandom& inout_rng)
{
  double px, py, pz;
  double len = 0.0;
...
template <typename Type>
plVec3Template<Type> plVec3Template<Type>::MakeRandomDirection(plRandom& inout_rng)
{
...
template <typename Type>
plVec3Template<Type> plVec3Template<Type>::MakeRandomDeviationX(plRandom& inout_rng, const plAngle& maxDeviation)
{
...
template <typename Type>
plVec3Template<Type> plVec3Template<Type>::MakeRandomDeviationY(plRandom& inout_rng, const plAngle& maxDeviation)
{
...
template <typename Type>
plVec3Template<Type> plVec3Template<Type>::MakeRandomDeviationZ(plRandom& inout_rng, const plAngle& maxDeviation)
{
  plVec3Template<Type> vec = MakeRandomDeviationX(inout_rng, maxDeviation);
...
template <typename Type>
plVec3Template<Type> plVec3Template<Type>::MakeRandomDeviation(plRandom& inout_rng, const plAngle& maxDeviation, const plVec3Template<Type>& vNormal)
{
