...
#define FIXEDPOINT_OVERLOADS(Bits)                                                                                                       \
  template <>                                                                                                                            \
  PLASMA_ALWAYS_INLINE plFixedPoint<Bits> BasicType<plFixedPoint<Bits>>::MaxValue() { return (plFixedPoint<Bits>)((1 << (31 - Bits)) - 1); } \
  template <>                                                                                                                            \
  PLASMA_ALWAYS_INLINE plFixedPoint<Bits> BasicType<plFixedPoint<Bits>>::SmallEpsilon() { return (plFixedPoint<Bits>)0.0001; }               \
  template <>                                                                                                                            \
  PLASMA_ALWAYS_INLINE plFixedPoint<Bits> BasicType<plFixedPoint<Bits>>::DefaultEpsilon() { return (plFixedPoint<Bits>)0.001; }              \
  template <>                                                                                                                            \
  PLASMA_ALWAYS_INLINE plFixedPoint<Bits> BasicType<plFixedPoint<Bits>>::LargeEpsilon() { return (plFixedPoint<Bits>)0.01; }                 \
  template <>                                                                                                                            \
  PLASMA_ALWAYS_INLINE plFixedPoint<Bits> BasicType<plFixedPoint<Bits>>::HugeEpsilon() { return (plFixedPoint<Bits>)0.1; }
  ...
  PLASMA_FORCE_INLINE plFixedPoint<DecimalBits> Floor(plFixedPoint<DecimalBits> f)
  {
    PLASMA_REPORT_FAILURE("This function is not really implemented yet.");

    return (plFixedPoint<DecimalBits>)floor(f.ToDouble());
  }

  template <plUInt8 DecimalBits>
  PLASMA_FORCE_INLINE plFixedPoint<DecimalBits> Ceil(plFixedPoint<DecimalBits> f)
  {
    PLASMA_REPORT_FAILURE("This function is not really implemented yet.");
  ...
  template <plUInt8 DecimalBits>
  PLASMA_FORCE_INLINE plFixedPoint<DecimalBits> Exp(plFixedPoint<DecimalBits> f)
  {
    PLASMA_REPORT_FAILURE("This function is not really implemented yet.");
  ...
  template <plUInt8 DecimalBits>
  PLASMA_FORCE_INLINE plFixedPoint<DecimalBits> Ln(plFixedPoint<DecimalBits> f)
  {
    PLASMA_REPORT_FAILURE("This function is not really implemented yet.");
  ...
  template <plUInt8 DecimalBits>
  PLASMA_FORCE_INLINE plFixedPoint<DecimalBits> Log2(plFixedPoint<DecimalBits> f)
  {
    PLASMA_REPORT_FAILURE("This function is not really implemented yet.");
  ...
  template <plUInt8 DecimalBits>
  PLASMA_FORCE_INLINE plFixedPoint<DecimalBits> Log10(plFixedPoint<DecimalBits> f)
  {
    PLASMA_REPORT_FAILURE("This function is not really implemented yet.");
  ...
  template <plUInt8 DecimalBits>
  PLASMA_FORCE_INLINE plFixedPoint<DecimalBits> Log(plFixedPoint<DecimalBits> fBase, plFixedPoint<DecimalBits> f)
  {
    PLASMA_REPORT_FAILURE("This function is not really implemented yet.");
  ...
  template <plUInt8 DecimalBits>
  PLASMA_FORCE_INLINE plFixedPoint<DecimalBits> Pow2(plFixedPoint<DecimalBits> f)
  {
    PLASMA_REPORT_FAILURE("This function is not really implemented yet.");
  ...
  template <plUInt8 DecimalBits>
  PLASMA_FORCE_INLINE plFixedPoint<DecimalBits> Pow(plFixedPoint<DecimalBits> base, plFixedPoint<DecimalBits> exp)
  {
    PLASMA_REPORT_FAILURE("This function is not really implemented yet.");
  ...
  template <plUInt8 DecimalBits>
  PLASMA_FORCE_INLINE plFixedPoint<DecimalBits> Root(plFixedPoint<DecimalBits> f, plFixedPoint<DecimalBits> NthRoot)
  {
    PLASMA_REPORT_FAILURE("This function is not really implemented yet.");
  ...
  template <plUInt8 DecimalBits>
  PLASMA_FORCE_INLINE plFixedPoint<DecimalBits> Mod(plFixedPoint<DecimalBits> f, plFixedPoint<DecimalBits> div)
  {
    PLASMA_REPORT_FAILURE("This function is not really implemented yet.");
