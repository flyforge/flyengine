...
PL_FORCE_INLINE plBoundingBoxSphereTemplate<Type>::plBoundingBoxSphereTemplate()
{
...
template <typename Type>
PL_FORCE_INLINE plBoundingBoxSphereTemplate<Type>::plBoundingBoxSphereTemplate(const plBoundingBoxSphereTemplate& rhs)
{
...
template <typename Type>
PL_FORCE_INLINE plBoundingBoxSphereTemplate<Type> plBoundingBoxSphereTemplate<Type>::MakeZero()
{
...
template <typename Type>
PL_FORCE_INLINE plBoundingBoxSphereTemplate<Type> plBoundingBoxSphereTemplate<Type>::MakeInvalid()
{
  plBoundingBoxSphereTemplate<Type> res;
  res.m_vCenter.SetZero();
...
template <typename Type>
PL_FORCE_INLINE plBoundingBoxSphereTemplate<Type> plBoundingBoxSphereTemplate<Type>::MakeFromCenterExtents(const plVec3Template<Type>& vCenter, const plVec3Template<Type>& vBoxHalfExtents, Type fSphereRadius)
{
  plBoundingBoxSphereTemplate<Type> res;
...
template <typename Type>
PL_FORCE_INLINE bool plBoundingBoxSphereTemplate<Type>::IsValid() const
{
  return (m_vCenter.IsValid() && m_fSphereRadius >= 0.0f && m_vBoxHalfExtends.IsValid());
}

template <typename Type>
PL_FORCE_INLINE bool plBoundingBoxSphereTemplate<Type>::IsNaN() const
{
  return (m_vCenter.IsNaN() || plMath::IsNaN(m_fSphereRadius) || m_vBoxHalfExtends.IsNaN());
}

template <typename Type>
PL_FORCE_INLINE const plBoundingBoxTemplate<Type> plBoundingBoxSphereTemplate<Type>::GetBox() const
{
  return plBoundingBoxTemplate<Type>::MakeFromMinMax(m_vCenter - m_vBoxHalfExtends, m_vCenter + m_vBoxHalfExtends);
}

template <typename Type>
PL_FORCE_INLINE const plBoundingSphereTemplate<Type> plBoundingBoxSphereTemplate<Type>::GetSphere() const
{
...
template <typename Type>
PL_FORCE_INLINE bool operator==(const plBoundingBoxSphereTemplate<Type>& lhs, const plBoundingBoxSphereTemplate<Type>& rhs)
{
...
template <typename Type>
PL_ALWAYS_INLINE bool operator!=(const plBoundingBoxSphereTemplate<Type>& lhs, const plBoundingBoxSphereTemplate<Type>& rhs)
{
  return !(lhs == rhs);
}
