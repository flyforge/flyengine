...
template <typename Type>
PL_ALWAYS_INLINE plTransformTemplate<Type> plTransformTemplate<Type>::MakeGlobalTransform(const plTransformTemplate& globalTransformParent, const plTransformTemplate& localTransformChild)
{
  return globalTransformParent * localTransformChild;
}

template <typename Type>
PL_ALWAYS_INLINE void plTransformTemplate<Type>::SetIdentity()
{
  *this = MakeIdentity();
}

template <typename Type>
PL_ALWAYS_INLINE Type plTransformTemplate<Type>::GetMaxScale() const
{
...
template <typename Type>
PL_ALWAYS_INLINE bool plTransformTemplate<Type>::ContainsNegativeScale() const
{
  return (m_vScale.x * m_vScale.y * m_vScale.z) < 0.0f;
}

template <typename Type>
PL_ALWAYS_INLINE bool plTransformTemplate<Type>::ContainsUniformScale() const
{
...
template <typename Type>
PL_ALWAYS_INLINE const plMat4Template<Type> plTransformTemplate<Type>::GetAsMat4() const
{
...
template <typename Type>
PL_ALWAYS_INLINE void plTransformTemplate<Type>::operator+=(const plVec3Template<Type>& v)
{
  m_vPosition += v;
}
...
template <typename Type>
PL_ALWAYS_INLINE plVec3Template<Type> plTransformTemplate<Type>::TransformPosition(const plVec3Template<Type>& v) const
{
...
template <typename Type>
PL_ALWAYS_INLINE plVec3Template<Type> plTransformTemplate<Type>::TransformDirection(const plVec3Template<Type>& v) const
{
  const auto scaled = m_vScale.CompMul(v);
  const auto rotated = m_qRotation * scaled;
  return rotated;
...
template <typename Type>
PL_ALWAYS_INLINE const plTransformTemplate<Type> operator*(const plQuatTemplate<Type>& q, const plTransformTemplate<Type>& t)
{
  plTransform r;
...
template <typename Type>
PL_ALWAYS_INLINE const plTransformTemplate<Type> operator*(const plTransformTemplate<Type>& t, const plQuatTemplate<Type>& q)
{
  plTransform r;
...
template <typename Type>
PL_ALWAYS_INLINE const plTransformTemplate<Type> operator+(const plTransformTemplate<Type>& t, const plVec3Template<Type>& v)
{
...
template <typename Type>
PL_ALWAYS_INLINE const plVec3Template<Type> operator*(const plTransformTemplate<Type>& t, const plVec3Template<Type>& v)
{
...
template <typename Type>
PL_ALWAYS_INLINE bool operator==(const plTransformTemplate<Type>& t1, const plTransformTemplate<Type>& t2)
{
...
template <typename Type>
PL_ALWAYS_INLINE void plTransformTemplate<Type>::Invert()
{
  (*this) = GetInverse();
}
