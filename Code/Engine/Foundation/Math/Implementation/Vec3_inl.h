...
PL_FORCE_INLINE plVec3Template<Type>::plVec3Template()
{
...
template <typename Type>
PL_ALWAYS_INLINE plVec3Template<Type>::plVec3Template(Type x, Type y, Type z)
  : x(x)
  , y(y)
  , z(z)
{
...
template <typename Type>
PL_ALWAYS_INLINE plVec3Template<Type>::plVec3Template(Type v)
  : x(v)
  , y(v)
  , z(v)
{
...
template <typename Type>
PL_ALWAYS_INLINE void plVec3Template<Type>::Set(Type xyz)
{
  x = xyz;
  y = xyz;
  z = xyz;
...
template <typename Type>
PL_ALWAYS_INLINE void plVec3Template<Type>::Set(Type inX, Type inY, Type inZ)
{
  x = inX;
  y = inY;
  z = inZ;
...
template <typename Type>
PL_ALWAYS_INLINE void plVec3Template<Type>::SetZero()
{
  x = y = z = 0;
}

template <typename Type>
PL_IMPLEMENT_IF_FLOAT_TYPE PL_ALWAYS_INLINE Type plVec3Template<Type>::GetLength() const
{
  return (plMath::Sqrt(GetLengthSquared()));
}

template <typename Type>
PL_IMPLEMENT_IF_FLOAT_TYPE plResult plVec3Template<Type>::SetLength(Type fNewLength, Type fEpsilon /* = plMath::DefaultEpsilon<Type>() */)
{
  if (NormalizeIfNotZero(plVec3Template<Type>::MakeZero(), fEpsilon) == PL_FAILURE)
    return PL_FAILURE;
...
template <typename Type>
PL_FORCE_INLINE Type plVec3Template<Type>::GetLengthSquared() const
{
  PL_NAN_ASSERT(this);
...
template <typename Type>
PL_IMPLEMENT_IF_FLOAT_TYPE PL_FORCE_INLINE Type plVec3Template<Type>::GetLengthAndNormalize()
{
...
template <typename Type>
PL_IMPLEMENT_IF_FLOAT_TYPE PL_FORCE_INLINE const plVec3Template<Type> plVec3Template<Type>::GetNormalized() const
{
...
template <typename Type>
PL_IMPLEMENT_IF_FLOAT_TYPE PL_ALWAYS_INLINE void plVec3Template<Type>::Normalize()
{
  *this /= GetLength();
}

template <typename Type>
PL_IMPLEMENT_IF_FLOAT_TYPE plResult plVec3Template<Type>::NormalizeIfNotZero(const plVec3Template<Type>& vFallback, Type fEpsilon)
{
...
template <typename Type>
PL_FORCE_INLINE bool plVec3Template<Type>::IsZero() const
{
  PL_NAN_ASSERT(this);
...
template <typename Type>
PL_FORCE_INLINE const plVec3Template<Type> plVec3Template<Type>::operator-() const
{
  PL_NAN_ASSERT(this);
...
template <typename Type>
PL_FORCE_INLINE void plVec3Template<Type>::operator*=(const plVec3Template& rhs)
{
  /// \test this is new
...
template <typename Type>
PL_FORCE_INLINE void plVec3Template<Type>::operator*=(Type f)
{
  x *= f;
  y *= f;
  z *= f;
...
template <typename Type>
PL_IMPLEMENT_IF_FLOAT_TYPE plResult plVec3Template<Type>::CalculateNormal(const plVec3Template<Type>& v1, const plVec3Template<Type>& v2, const plVec3Template<Type>& v3)
{
...
template <typename Type>
PL_IMPLEMENT_IF_FLOAT_TYPE const plVec3Template<Type> plVec3Template<Type>::GetOrthogonalVector() const
{
...
template <typename Type>
PL_IMPLEMENT_IF_FLOAT_TYPE const plVec3Template<Type> plVec3Template<Type>::GetReflectedVector(const plVec3Template<Type>& vNormal) const
{
...
template <typename Type>
PL_FORCE_INLINE Type plVec3Template<Type>::Dot(const plVec3Template<Type>& rhs) const
{
  PL_NAN_ASSERT(this);
  PL_NAN_ASSERT(&rhs);
...
template <typename Type>
PL_FORCE_INLINE const plVec3Template<Type> plVec3Template<Type>::CompMin(const plVec3Template<Type>& rhs) const
{
  PL_NAN_ASSERT(this);
  PL_NAN_ASSERT(&rhs);
...
template <typename Type>
PL_FORCE_INLINE const plVec3Template<Type> plVec3Template<Type>::CompMax(const plVec3Template<Type>& rhs) const
{
  PL_NAN_ASSERT(this);
  PL_NAN_ASSERT(&rhs);
...
template <typename Type>
PL_FORCE_INLINE const plVec3Template<Type> plVec3Template<Type>::CompClamp(const plVec3Template& vLow, const plVec3Template& vHigh) const
{
  PL_NAN_ASSERT(this);
  PL_NAN_ASSERT(&vLow);
  PL_NAN_ASSERT(&vHigh);
...
template <typename Type>
PL_FORCE_INLINE const plVec3Template<Type> plVec3Template<Type>::CompMul(const plVec3Template<Type>& rhs) const
{
  PL_NAN_ASSERT(this);
  PL_NAN_ASSERT(&rhs);
...
template <typename Type>
PL_FORCE_INLINE const plVec3Template<Type> plVec3Template<Type>::CompDiv(const plVec3Template<Type>& rhs) const
{
  PL_NAN_ASSERT(this);
  PL_NAN_ASSERT(&rhs);
...
template <typename Type>
PL_FORCE_INLINE const plVec3Template<Type> operator+(const plVec3Template<Type>& v1, const plVec3Template<Type>& v2)
{
  PL_NAN_ASSERT(&v1);
  PL_NAN_ASSERT(&v2);
...
template <typename Type>
PL_FORCE_INLINE const plVec3Template<Type> operator*(Type f, const plVec3Template<Type>& v)
{
  PL_NAN_ASSERT(&v);
...
template <typename Type>
PL_FORCE_INLINE const plVec3Template<Type> operator*(const plVec3Template<Type>& v, Type f)
{
  PL_NAN_ASSERT(&v);
...
template <typename Type>
PL_ALWAYS_INLINE bool operator==(const plVec3Template<Type>& v1, const plVec3Template<Type>& v2)
{
...
template <typename Type>
PL_FORCE_INLINE bool operator<(const plVec3Template<Type>& v1, const plVec3Template<Type>& v2)
{
  PL_NAN_ASSERT(&v1);
  PL_NAN_ASSERT(&v2);
...
template <typename Type>
PL_IMPLEMENT_IF_FLOAT_TYPE const plVec3Template<Type> plVec3Template<Type>::GetRefractedVector(const plVec3Template<Type>& vNormal, Type fRefIndex1, Type fRefIndex2) const
{
  PL_ASSERT_DEBUG(vNormal.IsNormalized(), "vNormal must be normalized.");
