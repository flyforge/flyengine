...
PLASMA_FORCE_INLINE const plVec3Template<Type> plVec2Template<Type>::GetAsVec3(Type z) const
{
...
template <typename Type>
PLASMA_FORCE_INLINE const plVec4Template<Type> plVec2Template<Type>::GetAsVec4(Type z, Type w) const
{
  PLASMA_NAN_ASSERT(this);
...
template <typename Type>
PLASMA_FORCE_INLINE const plVec2Template<Type> plVec3Template<Type>::GetAsVec2() const
{
...
template <typename Type>
PLASMA_FORCE_INLINE const plVec4Template<Type> plVec3Template<Type>::GetAsVec4(Type w) const
{
  PLASMA_NAN_ASSERT(this);
...
template <typename Type>
PLASMA_FORCE_INLINE const plVec4Template<Type> plVec3Template<Type>::GetAsPositionVec4() const
{
...
template <typename Type>
PLASMA_FORCE_INLINE const plVec4Template<Type> plVec3Template<Type>::GetAsDirectionVec4() const
{
  // don't assert here, as the 4th component may be NaN when this is fine, e.g. during interop with the SIMD classes
  // PLASMA_NAN_ASSERT(this);
...
template <typename Type>
PLASMA_ALWAYS_INLINE plVec4Template<Type>::plVec4Template()
{
...
template <typename Type>
PLASMA_ALWAYS_INLINE plVec4Template<Type>::plVec4Template(Type x, Type y, Type z, Type w)
  : x(x)
  , y(y)
  , z(z)
  , w(w)
...
template <typename Type>
PLASMA_FORCE_INLINE const plVec2Template<Type> plVec4Template<Type>::GetAsVec2() const
{
  // don't assert here, as the 4th component may be NaN when this is fine, e.g. during interop with the SIMD classes
  // PLASMA_NAN_ASSERT(this);
...
template <typename Type>
PLASMA_FORCE_INLINE const plVec3Template<Type> plVec4Template<Type>::GetAsVec3() const
{
  // don't assert here, as the 4th component may be NaN when this is fine, e.g. during interop with the SIMD classes
  // PLASMA_NAN_ASSERT(this);
...
template <typename Type>
PLASMA_ALWAYS_INLINE void plVec4Template<Type>::Set(Type xyzw)
{
  x = xyzw;
  y = xyzw;
  z = xyzw;
...
template <typename Type>
PLASMA_ALWAYS_INLINE void plVec4Template<Type>::Set(Type inX, Type inY, Type inZ, Type inW)
{
  x = inX;
  y = inY;
  z = inZ;
...
template <typename Type>
PLASMA_ALWAYS_INLINE Type plVec4Template<Type>::GetLength() const
{
  return (plMath::Sqrt(GetLengthSquared()));
}

template <typename Type>
PLASMA_FORCE_INLINE Type plVec4Template<Type>::GetLengthSquared() const
{
  PLASMA_NAN_ASSERT(this);
...
template <typename Type>
PLASMA_FORCE_INLINE Type plVec4Template<Type>::GetLengthAndNormalize()
{
...
template <typename Type>
PLASMA_FORCE_INLINE const plVec4Template<Type> plVec4Template<Type>::GetNormalized() const
{
...
template <typename Type>
PLASMA_ALWAYS_INLINE void plVec4Template<Type>::Normalize()
{
  *this /= GetLength();
}

template <typename Type>
inline plResult plVec4Template<Type>::NormalizeIfNotZero(const plVec4Template<Type>& vFallback, Type fEpsilon)
{
...
*/
template <typename Type>
inline bool plVec4Template<Type>::IsNormalized(Type fEpsilon /* = plMath::HugeEpsilon<Type>() */) const
{
...
template <typename Type>
PLASMA_FORCE_INLINE const plVec4Template<Type> plVec4Template<Type>::operator-() const
{
  PLASMA_NAN_ASSERT(this);
...
template <typename Type>
PLASMA_FORCE_INLINE void plVec4Template<Type>::operator+=(const plVec4Template<Type>& vCc)
{
  x += vCc.x;
  y += vCc.y;
  z += vCc.z;
...
template <typename Type>
PLASMA_FORCE_INLINE void plVec4Template<Type>::operator*=(Type f)
{
  x *= f;
  y *= f;
  z *= f;
...
template <typename Type>
PLASMA_FORCE_INLINE Type plVec4Template<Type>::Dot(const plVec4Template<Type>& rhs) const
{
  PLASMA_NAN_ASSERT(this);
...
PLASMA_MSVC_ANALYSIS_WARNING_DISABLE(4723)
template <typename Type>
...
template <typename Type>
PLASMA_FORCE_INLINE const plVec4Template<Type> operator+(const plVec4Template<Type>& v1, const plVec4Template<Type>& v2)
{
...
template <typename Type>
PLASMA_FORCE_INLINE const plVec4Template<Type> operator*(Type f, const plVec4Template<Type>& v)
{
  PLASMA_NAN_ASSERT(&v);
...
template <typename Type>
PLASMA_FORCE_INLINE const plVec4Template<Type> operator*(const plVec4Template<Type>& v, Type f)
{
  PLASMA_NAN_ASSERT(&v);
...
template <typename Type>
PLASMA_ALWAYS_INLINE bool operator==(const plVec4Template<Type>& v1, const plVec4Template<Type>& v2)
{
...
template <typename Type>
PLASMA_FORCE_INLINE bool operator<(const plVec4Template<Type>& v1, const plVec4Template<Type>& v2)
{
  PLASMA_NAN_ASSERT(&v1);
  PLASMA_NAN_ASSERT(&v2);
