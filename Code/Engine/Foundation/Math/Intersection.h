...
namespace plIntersectionUtils
{
  ...
  PLASMA_FOUNDATION_DLL bool RayPolygonIntersection(const plVec3& vRayStartPos, const plVec3& vRayDir, const plVec3* pPolygonVertices,
  ...
  /// point is located.
  PLASMA_FOUNDATION_DLL plVec3 ClosestPoint_PointLineSegment(const plVec3& vStartPoint, const plVec3& vLineSegmentPos0, const plVec3& vLineSegmentPos1,
  ...
  PLASMA_FOUNDATION_DLL bool Ray2DLine2D(const plVec2& vRayStartPos, const plVec2& vRayDir, const plVec2& vLineSegmentPos0,
  ...
  PLASMA_FOUNDATION_DLL bool IsPointOnLine(const plVec3& vLineStart, const plVec3& vLineEnd, const plVec3& vPoint, float fMaxDist = 0.01f);
} // namespace plIntersectionUtils
