...
template <typename APPEND_CONTAINER_LAMBDA>
inline void plConversionUtils::ConvertBinaryToHex(const void* pBinaryData, plUInt32 uiBytes, APPEND_CONTAINER_LAMBDA append) // [tested]
{
  char tmp[4];

  plUInt8* pBytes = (plUInt8*)pBinaryData;
