...
int plStringUtils::vsnprintf(char* szOutputBuffer, unsigned int uiBufferSize, const char* szFormat, va_list szArgs0)
{
  va_list args;
...
int plStringUtils::snprintf(char* szOutputBuffer, unsigned int uiBufferSize, const char* szFormat, ...)
{
  va_list args;
...
void plStringUtils::OutputFormattedInt(
  char* szOutputBuffer, plUInt32 uiBufferSize, plUInt32& ref_uiWritePos, plInt64 value, plUInt8 uiWidth, bool bPadZeros, plUInt8 uiBase)
{
  OutputInt(szOutputBuffer, uiBufferSize, ref_uiWritePos, value, uiWidth, -1, bPadZeros ? sprintfFlags::PadZeros : 0, uiBase);
}

void plStringUtils::OutputFormattedUInt(
  char* szOutputBuffer, plUInt32 uiBufferSize, plUInt32& ref_uiWritePos, plUInt64 value, plUInt8 uiWidth, bool bPadZeros, plUInt8 uiBase, bool bUpperCase)
{
...
void plStringUtils::OutputFormattedFloat(char* szOutputBuffer, plUInt32 uiBufferSize, plUInt32& ref_uiWritePos, double value, plUInt8 uiWidth,
  bool bPadZeros, plInt8 iPrecision, bool bScientific, bool bRemoveTrailingZeroes)
{
  OutputFloat(szOutputBuffer, uiBufferSize, ref_uiWritePos, value, uiWidth, plMath::Max<int>(-1, iPrecision), bPadZeros ? sprintfFlags::PadZeros : 0,
