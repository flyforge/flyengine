...
private:
  ...
  static void LoadCVarsFromFileInternal(plStringView path, const plDynamicArray<plCVar*>& vars, bool bOnlyNewOnes, bool bSetAsCurrentValue, plDynamicArray<plCVar*>* pOutCVars);
