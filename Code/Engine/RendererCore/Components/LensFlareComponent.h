...
class PLASMA_RENDERERCORE_DLL plLensFlareRenderData : public plRenderData
{
  PLASMA_ADD_DYNAMIC_REFLECTION(plLensFlareRenderData, plRenderData);
...
PLASMA_DECLARE_REFLECTABLE_TYPE(PLASMA_RENDERERCORE_DLL, plLensFlareElement);

using plLensFlareComponentManager = plComponentManager<class plLensFlareComponent, plBlockStorageType::Compact>;

class PLASMA_RENDERERCORE_DLL plLensFlareComponent : public plRenderComponent
{
  PLASMA_DECLARE_COMPONENT_TYPE(plLensFlareComponent, plRenderComponent, plLensFlareComponentManager);
