...
class PL_RENDERERCORE_DLL plAtmosphericScatteringComponent : public plRenderComponent
{
  PL_DECLARE_COMPONENT_TYPE(plAtmosphericScatteringComponent, plRenderComponent, plAtmosphericScatteringComponentManager);
