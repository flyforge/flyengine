...
// clang-format off
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plLensFlareRenderData, 1, plRTTIDefaultAllocator<plLensFlareRenderData>)
...
// clang-format off
PL_BEGIN_STATIC_REFLECTED_TYPE(plLensFlareElement, plNoBase, 1, plRTTIDefaultAllocator<plLensFlareElement>)
{
  PL_BEGIN_PROPERTIES
  {
    ...
    PL_MEMBER_PROPERTY("GreyscaleTexture", m_bGreyscaleTexture),
    PL_MEMBER_PROPERTY("Color", m_Color)->AddAttributes(new plExposeColorAlphaAttribute()),
    PL_MEMBER_PROPERTY("ModulateByLightColor", m_bModulateByLightColor)->AddAttributes(new plDefaultValueAttribute(true)),
    PL_MEMBER_PROPERTY("Size", m_fSize)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(10000.0f), new plSuffixAttribute(" m")),
    PL_MEMBER_PROPERTY("MaxScreenSize", m_fMaxScreenSize)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(1.0f)),
    ...
    PL_MEMBER_PROPERTY("ShiftToCenter", m_fShiftToCenter),
    PL_MEMBER_PROPERTY("InverseTonemap", m_bInverseTonemap),
  }
  PL_END_PROPERTIES;
}
...
// clang-format off
PL_BEGIN_COMPONENT_TYPE(plLensFlareComponent, 1, plComponentMode::Static)
{
  PL_BEGIN_PROPERTIES
  {
    PL_ACCESSOR_PROPERTY("LinkToLightShape", GetLinkToLightShape, SetLinkToLightShape)->AddAttributes(new plDefaultValueAttribute(true)),
    PL_MEMBER_PROPERTY("Intensity", m_fIntensity)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(1.0f)),
    PL_ACCESSOR_PROPERTY("OcclusionSampleRadius", GetOcclusionSampleRadius, SetOcclusionSampleRadius)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(0.1f), new plSuffixAttribute(" m")),
    PL_MEMBER_PROPERTY("OcclusionSampleSpread", m_fOcclusionSampleSpread)->AddAttributes(new plClampValueAttribute(0.0f, 1.0f), new plDefaultValueAttribute(0.5f)),
    PL_MEMBER_PROPERTY("OcclusionDepthOffset", m_fOcclusionDepthOffset)->AddAttributes(new plSuffixAttribute(" m")),
    PL_MEMBER_PROPERTY("ApplyFog", m_bApplyFog)->AddAttributes(new plDefaultValueAttribute(true)),
    PL_ARRAY_MEMBER_PROPERTY("Elements", m_Elements)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(1.0f)),
  }
  PL_END_PROPERTIES;
  PL_BEGIN_ATTRIBUTES
  {
...
PL_STATICLINK_FILE(RendererCore, RendererCore_Components_Implementation_LensFlareComponent);
