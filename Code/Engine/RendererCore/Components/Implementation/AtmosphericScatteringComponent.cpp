...
// clang-format off
PLASMA_BEGIN_COMPONENT_TYPE(plAtmosphericScatteringComponent, 1, plComponentMode::Static)
{

  PLASMA_BEGIN_PROPERTIES
  {
    PLASMA_ACCESSOR_PROPERTY("PlanetRadius", GetPlanetRadius, SetPlanetRadius)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(6380000)),
    PLASMA_ACCESSOR_PROPERTY("AtmosphereRadius", GetAtmosphereRadius, SetAtmosphereRadius)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(7580000)),
    PLASMA_ACCESSOR_PROPERTY("RayleighScattering", GetRayleighScattering, SetRayleighScattering)->AddAttributes(new plDefaultValueAttribute(plColor(0.04, 0.22, 0.75))),
    PLASMA_ACCESSOR_PROPERTY("MieScattering", GetMieScattering, SetMieScattering)->AddAttributes(new plDefaultValueAttribute(plColor(0.64, 0.64, 0.64))),
    PLASMA_ACCESSOR_PROPERTY("Absorption", GetAbsorption, SetAbsorption)->AddAttributes(new plDefaultValueAttribute(plColor(0.01f, 0.01f, 0.01f))),
    PLASMA_ACCESSOR_PROPERTY("AmbientScattering", GetAmbientScattering, SetAmbientScattering)->AddAttributes(new plDefaultValueAttribute(plColor(0.01f, 0.02f, 0.02f))),
    PLASMA_ACCESSOR_PROPERTY("MieScatterDirection", GetMieScatterDirection, SetMieScatterDirection)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(0.7f)),
    PLASMA_ACCESSOR_PROPERTY("RayleighHeight", GetRayleighHeight, SetRayleighHeight)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(8e3)),
    PLASMA_ACCESSOR_PROPERTY("MieHeight", GetMieHeight, SetMieHeight)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(1.2e3)),
    PLASMA_ACCESSOR_PROPERTY("AbsorptionHeight", GetAbsorptionHeight, SetAbsorptionHeight)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(30e3)),
    PLASMA_ACCESSOR_PROPERTY("AbsorptionFalloff", GetAbsorptionFalloff, SetAbsorptionFalloff)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(4e3)),
    PLASMA_ACCESSOR_PROPERTY("RaySteps", GetRaySteps, SetRaySteps)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(32)),
    PLASMA_ACCESSOR_PROPERTY("LightSteps", GetLightSteps, SetLightSteps)->AddAttributes(new plClampValueAttribute(0.0f, plVariant()), new plDefaultValueAttribute(8)),
  }
...
void plAtmosphericScatteringComponent::Initialize()
{
  ...
  if (!m_hMaterial.IsValid())
  {
    ...
    desc.m_hBaseMaterial = plResourceManager::LoadResource<plMaterialResource>("{ ea1cfb3f-d720-47d3-8d9a-188c48cbc830 }"); // AtmosphericScattering.plMaterialAsset
...
PLASMA_STATICLINK_FILE(RendererCore, RendererCore_Components_Implementation_plAtmosphericScatteringComponent);
