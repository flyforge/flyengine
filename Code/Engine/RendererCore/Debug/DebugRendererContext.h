...
class PL_RENDERERCORE_DLL plDebugRendererContext
{
public:
  PL_ALWAYS_INLINE plDebugRendererContext()
    : m_uiId(-1)
  {
  }
  ...
  PL_ALWAYS_INLINE bool operator==(const plDebugRendererContext& other) const { return m_uiId == other.m_uiId; }
...
{
  PL_ALWAYS_INLINE static plUInt32 Hash(plDebugRendererContext value) { return plHashHelper<plUInt32>::Hash(value.m_uiId); }

  PL_ALWAYS_INLINE static bool Equal(plDebugRendererContext a, plDebugRendererContext b) { return a == b; }
};
