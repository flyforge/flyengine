...
class PL_RENDERERCORE_DLL plAmbientLightComponent : public plSettingsComponent
{
  PL_DECLARE_COMPONENT_TYPE(plAmbientLightComponent, plSettingsComponent, plAmbientLightComponentManager);
