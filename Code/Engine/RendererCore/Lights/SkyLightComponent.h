...
class PL_RENDERERCORE_DLL plSkyLightComponent : public plSettingsComponent
{
  PL_DECLARE_COMPONENT_TYPE(plSkyLightComponent, plSettingsComponent, plSkyLightComponentManager);
