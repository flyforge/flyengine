...
namespace
{
  PL_ALWAYS_INLINE plUInt32 CalculateTypeHash(const plRenderData* pRenderData)
  {
  ...
  PL_FORCE_INLINE plUInt32 CalculateDistance(const plRenderData* pRenderData, const plCamera& camera)
  {
