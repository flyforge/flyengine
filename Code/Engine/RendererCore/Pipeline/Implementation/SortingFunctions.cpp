...
// static
plUInt64 plRenderSortingFunctions::ByRenderDataThenFrontToBack(
  const plRenderData* pRenderData, plUInt32 uiRenderDataSortingKey, const plCamera& camera)
{
  const plUInt64 uiTypeHash = CalculateTypeHash(pRenderData);
  const plUInt64 uiRenderDataSortingKey64 = uiRenderDataSortingKey;
...
// static
plUInt64 plRenderSortingFunctions::BackToFrontThenByRenderData(
  const plRenderData* pRenderData, plUInt32 uiRenderDataSortingKey, const plCamera& camera)
{
  const plUInt64 uiTypeHash = CalculateTypeHash(pRenderData);
  const plUInt64 uiRenderDataSortingKey64 = uiRenderDataSortingKey;
