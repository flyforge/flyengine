...
// clang-format off
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plBloomPass, 1, plRTTIDefaultAllocator<plBloomPass>)
{
  PL_BEGIN_PROPERTIES
  {
    PL_MEMBER_PROPERTY("Input", m_PinInput),
    PL_MEMBER_PROPERTY("Output", m_PinOutput),
    PL_MEMBER_PROPERTY("Radius", m_fRadius)->AddAttributes(new plDefaultValueAttribute(0.2f), new plClampValueAttribute(0.01f, 1.0f)),
    PL_MEMBER_PROPERTY("Threshold", m_fThreshold)->AddAttributes(new plDefaultValueAttribute(1.0f)),
    PL_MEMBER_PROPERTY("Intensity", m_fIntensity)->AddAttributes(new plDefaultValueAttribute(0.3f)),
    PL_MEMBER_PROPERTY("InnerTintColor", m_InnerTintColor),
    PL_MEMBER_PROPERTY("MidTintColor", m_MidTintColor),
    PL_MEMBER_PROPERTY("OuterTintColor", m_OuterTintColor),
  }
  PL_END_PROPERTIES;
}
...
{
  {
    ...
    PL_ASSERT_DEV(m_hShader.IsValid(), "Could not load bloom shader!");
  }
...
PL_STATICLINK_FILE(RendererCore, RendererCore_Pipeline_Implementation_Passes_BloomPass);
