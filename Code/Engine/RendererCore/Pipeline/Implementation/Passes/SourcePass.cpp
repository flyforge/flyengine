...
// clang-format off
PLASMA_BEGIN_DYNAMIC_REFLECTED_TYPE(plSourcePass, 3, plRTTIDefaultAllocator<plSourcePass>)
{
  PLASMA_BEGIN_PROPERTIES
  {
    PLASMA_MEMBER_PROPERTY("Output", m_PinOutput),
    PLASMA_ENUM_MEMBER_PROPERTY("Format", plSourceFormat, m_Format),
...
PLASMA_BEGIN_STATIC_REFLECTED_ENUM(plSourceFormat, 1)
