...
// clang-format off
PL_BEGIN_DYNAMIC_REFLECTED_TYPE(plTonemapPass, 1, plRTTIDefaultAllocator<plTonemapPass>)
{
  PL_BEGIN_PROPERTIES
  {
    PL_MEMBER_PROPERTY("Color", m_PinColorInput),
    PL_MEMBER_PROPERTY("Bloom", m_PinBloomInput),
    PL_MEMBER_PROPERTY("Output", m_PinOutput),
    PL_ACCESSOR_PROPERTY("VignettingTexture", GetVignettingTextureFile, SetVignettingTextureFile)->AddAttributes(new plAssetBrowserAttribute("CompatibleAsset_Texture_2D")),
    PL_MEMBER_PROPERTY("MoodColor", m_MoodColor)->AddAttributes(new plDefaultValueAttribute(plColor::Orange)),
    PL_MEMBER_PROPERTY("MoodStrength", m_fMoodStrength)->AddAttributes(new plClampValueAttribute(0.0f, plVariant())),
    PL_MEMBER_PROPERTY("Saturation", m_fSaturation)->AddAttributes(new plClampValueAttribute(0.0f, 2.0f), new plDefaultValueAttribute(1.0f)),
    PL_MEMBER_PROPERTY("Contrast", m_fContrast)->AddAttributes(new plClampValueAttribute(0.0f, 1.0f)),
    PL_MEMBER_PROPERTY("LUT1Strength", m_fLut1Strength)->AddAttributes(new plClampValueAttribute(0.0f, 1.0f)),
    PL_MEMBER_PROPERTY("LUT2Strength", m_fLut2Strength)->AddAttributes(new plClampValueAttribute(0.0f, 1.0f)),
    PL_ACCESSOR_PROPERTY("LUT1", GetLUT1TextureFile, SetLUT1TextureFile)->AddAttributes(new plAssetBrowserAttribute("CompatibleAsset_Texture_3D")),
    PL_ACCESSOR_PROPERTY("LUT2", GetLUT2TextureFile, SetLUT2TextureFile)->AddAttributes(new plAssetBrowserAttribute("CompatibleAsset_Texture_3D")),
  }
  PL_END_PROPERTIES;
}
  ...
  : plRenderPipelinePass("TonemapPass", true)
{
  ...
  PL_ASSERT_DEV(m_hShader.IsValid(), "Could not load tonemap shader!");
...
PL_STATICLINK_FILE(RendererCore, RendererCore_Pipeline_Implementation_Passes_TonemapPass);
