...
namespace
{
  ...
  PLASMA_ALWAYS_INLINE plUInt32 ColorFloatToUNorm(float value)
  {
...
// clang-format off
PLASMA_BEGIN_STATIC_REFLECTED_ENUM(plMeshNormalPrecision, 1)
  PLASMA_ENUM_CONSTANT(plMeshNormalPrecision::_10Bit),
  PLASMA_ENUM_CONSTANT(plMeshNormalPrecision::_16Bit),
  PLASMA_ENUM_CONSTANT(plMeshNormalPrecision::_32Bit),
PLASMA_END_STATIC_REFLECTED_ENUM;

PLASMA_BEGIN_STATIC_REFLECTED_ENUM(plMeshTexCoordPrecision, 1)
  PLASMA_ENUM_CONSTANT(plMeshTexCoordPrecision::_16Bit),
  PLASMA_ENUM_CONSTANT(plMeshTexCoordPrecision::_32Bit),
PLASMA_END_STATIC_REFLECTED_ENUM;

PLASMA_BEGIN_STATIC_REFLECTED_ENUM(plMeshBoneWeigthPrecision, 1)
  PLASMA_ENUM_CONSTANT(plMeshBoneWeigthPrecision::_8Bit),
  PLASMA_ENUM_CONSTANT(plMeshBoneWeigthPrecision::_10Bit),
  PLASMA_ENUM_CONSTANT(plMeshBoneWeigthPrecision::_16Bit),
  PLASMA_ENUM_CONSTANT(plMeshBoneWeigthPrecision::_32Bit),
PLASMA_END_STATIC_REFLECTED_ENUM;
// clang-format on
...
{
  PLASMA_ASSERT_DEBUG(dest.GetCount() >= plGALResourceFormat::GetBitsPerElement(destFormat) / 8, "Destination buffer is too small");
...
{
  PLASMA_ASSERT_DEBUG(source.GetCount() >= plGALResourceFormat::GetBitsPerElement(sourceFormat) / 8, "Source buffer is too small");
  ...
  for (plUInt32 vs = 0; vs < vdi.m_VertexStreams.GetCount(); ++vs)
  {
    if (vdi.m_VertexStreams[vs].m_Semantic == plGALVertexAttributeSemantic::Position)
    {
      if (vdi.m_VertexStreams[vs].m_Format != plGALResourceFormat::RGBFloat)
      {
        ...
        return PLASMA_FAILURE; // other position formats are not supported
      }
...
PLASMA_STATICLINK_FILE(RendererCore, RendererCore_Meshes_Implementation_MeshBufferUtils);
