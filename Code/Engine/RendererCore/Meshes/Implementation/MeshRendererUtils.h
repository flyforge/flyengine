...
{
  PLASMA_FORCE_INLINE void FillPerInstanceData(plPerInstanceData& ref_perInstanceData, const plMeshRenderData* pRenderData)
  {
    ...
    ref_perInstanceData.Wind = pRenderData->m_Wind;
  }
} // namespace plInternal
