...
class PL_GAMEENGINE_DLL plWindowXR : public plWindowBase
{
public:
...
class PL_GAMEENGINE_DLL plWindowOutputTargetXR : public plWindowOutputTargetBase
{
public:
...
class PL_GAMEENGINE_DLL plActorPluginWindowXR : public plActorPluginWindow
{
  PL_ADD_DYNAMIC_REFLECTION(plActorPluginWindowXR, plActorPluginWindow);
