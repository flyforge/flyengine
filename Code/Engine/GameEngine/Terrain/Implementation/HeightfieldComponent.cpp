...
// clang-format off
PLASMA_BEGIN_COMPONENT_TYPE(plHeightfieldComponent, 2, plComponentMode::Static)
{
  PLASMA_BEGIN_PROPERTIES
  {
    PLASMA_ACCESSOR_PROPERTY("HeightfieldImage", GetHeightfieldFile, SetHeightfieldFile)->AddAttributes(new plAssetBrowserAttribute("CompatibleAsset_Data_2D")),
    ...
    PLASMA_ACCESSOR_PROPERTY("HalfExtents", GetHalfExtents, SetHalfExtents)->AddAttributes(new plDefaultValueAttribute(plVec2(50))),
    PLASMA_ACCESSOR_PROPERTY("Height", GetHeight, SetHeight)->AddAttributes(new plDefaultValueAttribute(50)),
    PLASMA_ACCESSOR_PROPERTY("Tesselation", GetTesselation, SetTesselation)->AddAttributes(new plDefaultValueAttribute(plVec2U32(128))),
    PLASMA_ACCESSOR_PROPERTY("TexCoordOffset", GetTexCoordOffset, SetTexCoordOffset)->AddAttributes(new plDefaultValueAttribute(plVec2(0))),
    PLASMA_ACCESSOR_PROPERTY("TexCoordScale", GetTexCoordScale, SetTexCoordScale)->AddAttributes(new plDefaultValueAttribute(plVec2(1))),
    ...
    PLASMA_ACCESSOR_PROPERTY("ColMeshTesselation", GetColMeshTesselation, SetColMeshTesselation)->AddAttributes(new plDefaultValueAttribute(plVec2U32(64))),
...
void plHeightfieldComponent::BuildGeometry(plGeometry& geom) const
{
  ...
  PLASMA_PROFILE_SCOPE("Heightfield: BuildGeometry");
...
{
  PLASMA_PROFILE_SCOPE("Heightfield: GenerateRenderMesh");
...

  {
    ...
    desc.SetBounds(plBoundingBox(vPosOffset, vPosOffset + vSize));
...
{
  auto desc = PLASMA_CREATE_MODULE_UPDATE_FUNCTION_DESC(plHeightfieldComponentManager::Update, this);
