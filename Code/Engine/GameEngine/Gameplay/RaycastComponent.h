...
///
class PLASMA_GAMEENGINE_DLL plRaycastComponent : public plComponent
{
  PLASMA_DECLARE_COMPONENT_TYPE(plRaycastComponent, plComponent, plRaycastComponentManager);
