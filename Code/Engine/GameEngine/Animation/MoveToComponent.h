...
typedef plComponentManagerSimple<class plMoveToComponent, plComponentUpdateType::WhenSimulating> plMoveToComponentManager;

PLASMA_DECLARE_FLAGS_OPERATORS(plMoveToComponentFlags);
...
class PLASMA_GAMEENGINE_DLL plMoveToComponent : public plComponent
{
  PLASMA_DECLARE_COMPONENT_TYPE(plMoveToComponent, plComponent, plMoveToComponentManager);
...
public:
  ...
  void SetTargetPosition(const plVec3& pos); // [ scriptable ]
