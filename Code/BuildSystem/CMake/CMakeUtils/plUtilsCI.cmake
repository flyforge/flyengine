# #####################################
# ## pl_ci_add_to_targets_list(<target> [C++])
# #####################################

function(pl_ci_add_to_targets_list TARGET_NAME LANGUAGE)
	if(PL_NO_TXT_FILES)
		return()
	endif()
...
# #####################################
# ## pl_ci_add_test(<target> [NEEDS_HW_ACCESS])
# #####################################
function(pl_ci_add_test TARGET_NAME)
	...
	if(ARG_UNPARSED_ARGUMENTS)
		message(FATAL_ERROR "pl_ci_add_test: Invalid arguments '${ARG_UNPARSED_ARGUMENTS}'")
	endif()
