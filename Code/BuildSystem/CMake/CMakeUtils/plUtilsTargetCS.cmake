# #####################################
# ## pl_create_target_cs(<LIBRARY | APPLICATION> <target-name>)
# #####################################
...
macro(pl_create_target_cs TYPE TARGET_NAME)
	...
	if(ARG_UNPARSED_ARGUMENTS)
		message(FATAL_ERROR "pl_create_target_cs: Invalid arguments '${ARG_UNPARSED_ARGUMENTS}'")
	endif()
	...
	elseif(${TYPE} STREQUAL "APPLICATION")
		...
		message(FATAL_ERROR "pl_create_target_cs: Missing argument to specify target type. Pass in 'APPLICATION' or 'SHARED_LIBRARY' or 'STATIC_LIBRARY'.")
	endif()
	...
	# use pl_make_winmain_executable if this is desired
