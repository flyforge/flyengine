...
macro(pl_create_target TYPE TARGET_NAME)
	...
	set(ARG_OPTIONS NO_PCH NO_UNITY NO_QT NO_PL_PREFIX ENABLE_RTTI NO_WARNINGS_AS_ERRORS NO_COMPLIANCE ALL_SYMBOLS_VISIBLE NO_DEBUG)
	...
	if((NOT ANDROID) OR(NOT PL_CMAKE_INSIDE_VS))
		# PLATFORM-TODO
	...
	if(PL_CMAKE_PLATFORM_WINDOWS AND NOT PL_CMAKE_GENERATOR_MSVC)
		set(RC_FILES ${ALL_SOURCE_FILES})
		list(FILTER RC_FILES INCLUDE REGEX ".*\\.rc$")

		if(RC_FILES)
			set_source_files_properties(${RC_FILES}
				PROPERTIES COMPILE_FLAGS "/I\"C:/Program Files (x86)/Windows Kits/10/Include/${PL_CMAKE_WINDOWS_SDK_VERSION}/shared\" /I\"C:/Program Files (x86)/Windows Kits/10/Include/${PL_CMAKE_WINDOWS_SDK_VERSION}/um\""
			)
		endif()
	endif()
