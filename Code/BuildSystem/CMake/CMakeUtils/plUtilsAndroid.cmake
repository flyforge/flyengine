# #####################################
# ## pl_list_subdirs(result curdir)
# #####################################

macro(pl_list_subdirs result curdir)
...
# #####################################
# ## pl_android_add_default_content(<target>)
# #####################################
function(pl_android_add_default_content TARGET_NAME)
	pl_pull_all_vars()

	if(NOT PLASMA_CMAKE_PLATFORM_ANDROID)
		return()
	endif()
	...
	set(CONTENT_DIRECTORY_SRC "${CMAKE_SOURCE_DIR}/${PLASMA_SUBMODULE_PREFIX_PATH}/Data/Platform/Android")
	...
	pl_list_subdirs(AVAILABLE_BUILD_TOOLS ${ANDROID_BUILD_TOOLS_ROOT})
