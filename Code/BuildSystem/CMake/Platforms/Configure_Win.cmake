...
macro(pl_platformhook_find_vulkan)
    ...
    if(PLVULKAN_FOUND)
        if(PL_CMAKE_ARCHITECTURE_64BIT)
            ...
            set_target_properties(EzVulkan::Loader PROPERTIES IMPORTED_LOCATION "${PL_VULKAN_DIR}/Lib/vulkan-1.lib")
            set_target_properties(EzVulkan::Loader PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${PL_VULKAN_DIR}/Include")

            add_library(EzVulkan::DXC SHARED IMPORTED)
            set_target_properties(EzVulkan::DXC PROPERTIES IMPORTED_LOCATION "${PL_VULKAN_DIR}/Bin/dxcompiler.dll")
            set_target_properties(EzVulkan::DXC PROPERTIES IMPORTED_IMPLIB "${PL_VULKAN_DIR}/Lib/dxcompiler.lib")
            set_target_properties(EzVulkan::DXC PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${PL_VULKAN_DIR}/Include")
        else()
            message(FATAL_ERROR "TODO: Vulkan is not yet supported on this platform and/or architecture.")
        endif()
    endif()    
